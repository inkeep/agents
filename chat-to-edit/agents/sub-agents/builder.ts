  ...
  canUse: () => [
    inkeepManagementTools.with({
      ...
      selectedTools: [
        ...
        { name: "sub-agent-external-agent-relations-create-sub-agent-external-agent-relation", needsApproval: true },
        "sub-agent-external-agent-relations-get-sub-agent-external-agent-relation-by-id",
        { name: "sub-agent-external-agent-relations-update-sub-agent-external-agent-relation", needsApproval: true },
        { name: "sub-agent-external-agent-relations-delete-sub-agent-external-agent-relation", needsApproval: true },
        // Sub-agent team agent relations
        "sub-agent-team-agent-relations-list-sub-agent-team-agent-relations",
        { name: "sub-agent-team-agent-relations-create-sub-agent-team-agent-relation", needsApproval: true },
        "sub-agent-team-agent-relations-get-sub-agent-team-agent-relation-by-id",
        { name: "sub-agent-team-agent-relations-update-sub-agent-team-agent-relation", needsApproval: true },
        { name: "sub-agent-team-agent-relations-delete-sub-agent-team-agent-relation", needsApproval: true },
        // Agents
        "agents-list-agents",
        ...
        { name: "agent-artifact-component-relations-associate-artifact-component-with-agent", needsApproval: true },
        { name: "agent-artifact-component-relations-remove-artifact-component-from-agent", needsApproval: true },
        ...
        { name: "agent-data-component-relations-associate-data-component-with-agent", needsApproval: true },
        { name: "agent-data-component-relations-remove-data-component-from-agent", needsApproval: true },
