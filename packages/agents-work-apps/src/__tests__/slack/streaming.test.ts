  ...
  describe('tool-approval-request event handling', () => {
    ...
    describe('tool-auth-required event handling', () => {
      it('should render auth required blocks at stream completion', async () => {
        const sseData =
          'data: {"type":"data-tool-auth-required","data":{"type":"data-tool-auth-required","toolName":"Linear Ticketing","toolId":"tool-1","toolCallId":"tc-1","message":"Auth required"}}\n' +
      ...
      it('should collect multiple auth errors and render each as a block', async () => {
        const sseData =
          'data: {"type":"data-tool-auth-required","data":{"type":"data-tool-auth-required","toolName":"Linear","toolId":"tool-1","toolCallId":"tc-1","message":"Auth required"}}\n' +
          'data: {"type":"data-tool-auth-required","data":{"type":"data-tool-auth-required","toolName":"GitHub","toolId":"tool-2","toolCallId":"tc-2","message":"Auth required"}}\n' +
          'data: {"type":"data-operation","data":{"type":"completion"}}\n';
