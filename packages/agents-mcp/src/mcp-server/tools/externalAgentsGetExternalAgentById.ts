...
export const tool$externalAgentsGetExternalAgentById: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await externalAgentsGetExternalAgentById(
      client,
      args.request,
