...
export const tool$externalAgentsDeleteExternalAgent: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await externalAgentsDeleteExternalAgent(
      client,
      args.request,
