...
export const tool$externalAgentsUpdateExternalAgent: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await externalAgentsUpdateExternalAgent(
      client,
      args.request,
