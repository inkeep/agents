...
export const tool$thirdPartyMCPServersGetThirdPartyMCPServer: ToolDefinition<
  typeof args
> = {
...
Fetch details for a specific third-party MCP server (e.g., Composio) including authentication status and connect URL`,
  ...
  tool: async (client, args, ctx) => {
    const [result] = await thirdPartyMCPServersGetThirdPartyMCPServer(
      client,
      args.request,
