...
import {
  ...
  TriggerWithWebhookUrlListResponse$zodSchema,
} from "./triggerwithwebhookurllistresponse.js";
...
export const ListTriggersRequest$zodSchema: z.ZodType<ListTriggersRequest> = z
  .object({
...
export const ListTriggersResponse$zodSchema: z.ZodType<ListTriggersResponse> = z
  .object({
    ...
    TriggerWithWebhookUrlListResponse:
      TriggerWithWebhookUrlListResponse$zodSchema.optional().describe(
        "List of triggers retrieved successfully",
      ),
