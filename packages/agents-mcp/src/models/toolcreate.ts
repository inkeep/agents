...
export const ToolCreateServer$zodSchema: z.ZodType<
  ToolCreateServer,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export type ToolCreateTransportType = z.infer<
  typeof ToolCreateTransportType$zodSchema
>;
...
export const ToolCreateTransport$zodSchema: z.ZodType<
  ToolCreateTransport,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export const ToolCreateMcp$zodSchema: z.ZodType<
  ToolCreateMcp,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export const ToolCreateConfig$zodSchema: z.ZodType<
  ToolCreateConfig,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export const ToolCreate$zodSchema: z.ZodType<
  ToolCreate,
  z.ZodTypeDef,
  unknown
> = z.object({
