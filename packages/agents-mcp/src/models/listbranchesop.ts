...
export type ListBranchesRequest = { tenantId: string; projectId: string };

export const ListBranchesRequest$zodSchema: z.ZodType<ListBranchesRequest> = z
  .object({
...
export const ListBranchesResponse$zodSchema: z.ZodType<ListBranchesResponse> = z
  .object({
