...
export type DeleteAppAuthKeyRequest = {
  tenantId: string;
  projectId: string;
  appId: string;
  kid: string;
...
export const DeleteAppAuthKeyRequest$zodSchema: z.ZodType<
...
export type DeleteAppAuthKeyResponse = {
  ContentType: string;
  StatusCode: number;
...
export const DeleteAppAuthKeyResponse$zodSchema: z.ZodType<
  DeleteAppAuthKeyResponse
> = z.object({
