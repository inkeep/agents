...
export const GetSkillFileRequest$zodSchema: z.ZodType<GetSkillFileRequest> = z
  .object({
...
export const GetSkillFileResponse$zodSchema: z.ZodType<GetSkillFileResponse> = z
  .object({
