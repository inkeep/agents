...
export type RemoveFunctionToolFromSubAgentRequest = {
  tenantId: string;
  projectId: string;
  agentId: string;
  subAgentId: string;
...
export const RemoveFunctionToolFromSubAgentRequest$zodSchema: z.ZodType<
...
export type RemoveFunctionToolFromSubAgentResponse = {
  ContentType: string;
  StatusCode: number;
...
export const RemoveFunctionToolFromSubAgentResponse$zodSchema: z.ZodType<
