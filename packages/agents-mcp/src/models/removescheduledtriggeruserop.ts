...
export type RemoveScheduledTriggerUserRequest = {
  tenantId: string;
  projectId: string;
  agentId: string;
  id: string;
...
export const RemoveScheduledTriggerUserRequest$zodSchema: z.ZodType<
...
export type RemoveScheduledTriggerUserResponse = {
  ContentType: string;
  StatusCode: number;
...
export const RemoveScheduledTriggerUserResponse$zodSchema: z.ZodType<
  RemoveScheduledTriggerUserResponse
> = z.object({
