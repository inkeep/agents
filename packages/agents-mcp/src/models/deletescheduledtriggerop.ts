...
export type DeleteScheduledTriggerRequest = {
  tenantId: string;
  projectId: string;
  agentId: string;
  id: string;
...
export const DeleteScheduledTriggerRequest$zodSchema: z.ZodType<
...
export type DeleteScheduledTriggerResponse = {
  ContentType: string;
  StatusCode: number;
...
export const DeleteScheduledTriggerResponse$zodSchema: z.ZodType<
