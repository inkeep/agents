...
import {
  ApiKeyListResponse,
  ApiKeyListResponse$zodSchema,
} from "./apikeylistresponse.js";
...
export const ListApiKeysRequest$zodSchema: z.ZodType<
  ListApiKeysRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export const ListApiKeysResponse$zodSchema: z.ZodType<
  ListApiKeysResponse,
  z.ZodTypeDef,
  unknown
> = z.object({
