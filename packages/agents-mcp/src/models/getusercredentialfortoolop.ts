...
export type GetUserCredentialForToolRequest = {
  tenantId: string;
  projectId: string;
  id: string;
};

export const GetUserCredentialForToolRequest$zodSchema: z.ZodType<
...
export type GetUserCredentialForToolResponse = {
  ContentType: string;
  StatusCode: number;
...
export const GetUserCredentialForToolResponse$zodSchema: z.ZodType<
...
> = z.object({
  ...
  CredentialReferenceResponse: CredentialReferenceResponse$zodSchema.optional()
    .describe("User credential retrieved successfully"),
