...
export type GetAppByIdRequest = {
  tenantId: string;
  projectId: string;
  id: string;
};

export const GetAppByIdRequest$zodSchema: z.ZodType<GetAppByIdRequest> = z
  .object({
...
export type GetAppByIdResponse = {
  ContentType: string;
  StatusCode: number;
...
export const GetAppByIdResponse$zodSchema: z.ZodType<GetAppByIdResponse> = z
  .object({
    AppResponse: AppResponse$zodSchema.optional().describe("App found"),
