...
export type RemoveAgentFromDatasetRequest = {
  tenantId: string;
  projectId: string;
  datasetId: string;
  agentId: string;
...
export const RemoveAgentFromDatasetRequest$zodSchema: z.ZodType<
...
export type RemoveAgentFromDatasetResponse = {
  ContentType: string;
  StatusCode: number;
...
export const RemoveAgentFromDatasetResponse$zodSchema: z.ZodType<
  RemoveAgentFromDatasetResponse
> = z.object({
