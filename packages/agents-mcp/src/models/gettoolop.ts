...
export const GetToolRequest$zodSchema: z.ZodType<GetToolRequest> = z.object({
...
export const GetToolResponse$zodSchema: z.ZodType<GetToolResponse> = z.object({
  ...
  McpToolResponse: McpToolResponse$zodSchema.optional().describe("Tool found"),
