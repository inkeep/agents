...
export const ToolUpdateServer$zodSchema: z.ZodType<
  ToolUpdateServer,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export type ToolUpdateTransportType = z.infer<
  typeof ToolUpdateTransportType$zodSchema
>;
...
export const ToolUpdateTransport$zodSchema: z.ZodType<
  ToolUpdateTransport,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export const ToolUpdateMcp$zodSchema: z.ZodType<
  ToolUpdateMcp,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export const ToolUpdateConfig$zodSchema: z.ZodType<
  ToolUpdateConfig,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export const ToolUpdate$zodSchema: z.ZodType<
  ToolUpdate,
  z.ZodTypeDef,
  unknown
> = z.object({
