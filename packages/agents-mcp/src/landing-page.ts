...
export function landingPageHTML(origin: string): string {
  ...
  const mcpConfig = {
    ...
    "args": [
      ...
      `${o}/sse`,
      "--header",
      "cookie-auth:${COOKIE_AUTH}",
      "--header",
      "bearer-auth:${BEARER_AUTH}",
    ],
    "env": {
      "COOKIE_AUTH": "YOUR_VALUE_HERE",
...
<head>
    ...
    <title>@inkeep/agents-mcp MCP</title>
    <meta name="description" content="Install @inkeep/agents-mcp MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="@inkeep/agents-mcp - MCP Server">
    <meta property="og:description" content="Install @inkeep/agents-mcp MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="@inkeep/agents-mcp - MCP Server">
    <meta property="twitter:description" content="Install @inkeep/agents-mcp MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">@inkeep/agents-mcp</div>
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=InkeepAgents&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAaW5rZWVwL2FnZW50cy1tY3AiLCJzdGFydCIsIi0tY29va2llLWF1dGgiLCIiLCItLWJlYXJlci1hdXRoIiwiIl19">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=InkeepAgents&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAaW5rZWVwL2FnZW50cy1tY3AiLCJzdGFydCIsIi0tY29va2llLWF1dGgiLCIiLCItLWJlYXJlci1hdXRoIiwiIl19">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=InkeepAgents&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAaW5rZWVwL2FnZW50cy1tY3AiLCJzdGFydCIsIi0tY29va2llLWF1dGgiLCIiLCItLWJlYXJlci1hdXRoIiwiIl19">
              <div class="target">
            ...
            <a tabindex="0" class="card install-target install-link" href="vscode://ms-vscode.vscode-mcp/install?name=InkeepAgents&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAaW5rZWVwL2FnZW50cy1tY3AiLCJzdGFydCIsIi0tY29va2llLWF1dGgiLCIiLCItLWJlYXJlci1hdXRoIiwiIl19">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add InkeepAgents -- npx -y @inkeep/agents-mcp start --cookie-auth  --bearer-auth </code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add InkeepAgents -- npx -y @inkeep/agents-mcp start --cookie-auth  --bearer-auth </code>
        </div>
      </div>
    </div>
