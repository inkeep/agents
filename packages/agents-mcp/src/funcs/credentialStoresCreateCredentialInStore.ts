 ...
 */
export function credentialStoresCreateCredentialInStore(
...
> {
  ...
  const path$ = pathToFunc(
    "/manage/tenants/{tenantId}/projects/{projectId}/credential-stores/{id}/credentials",
  )(
    pathParams$,
  );
