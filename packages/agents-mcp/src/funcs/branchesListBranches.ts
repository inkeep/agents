...
export enum ListBranchesAcceptEnum {
 ...
 */
export function branchesListBranches(
...
async function $do(
  client$: InkeepAgentsCore,
  request: ListBranchesRequest,
  options?: RequestOptions & { acceptHeaderOverride?: ListBranchesAcceptEnum },
): Promise<
  [
    Result<
      ListBranchesResponse,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListBranchesRequest$zodSchema.parse(value$),
