 ...
 */
export function externalAgentsListSubAgentExternalAgentRelations(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      ListSubAgentExternalAgentRelationsRequest$zodSchema.parse(value$),
