...
import {
  RemoveAgentFromDatasetRequest,
  RemoveAgentFromDatasetRequest$zodSchema,
} from "../models/removeagentfromdatasetop.js";
import { APICall, APIPromise } from "../types/async.js";
import { Result } from "../types/fp.js";

/**
 * Remove Agent from Dataset
 */
export function evaluationsRemoveAgentFromDataset(
  client$: InkeepAgentsCore,
  request: RemoveAgentFromDatasetRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => RemoveAgentFromDatasetRequest$zodSchema.parse(value$),
