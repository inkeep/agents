...
export enum GetSkillsForSubagentAcceptEnum {
  applicationJsonAccept = "application/json",
  applicationProblemPlusJsonAccept = "application/problem+json",
}

/**
 * List Skills for Sub-Agent
 */
export function skillsGetSkillsForSubagent(
  client$: InkeepAgentsCore,
  request: GetSkillsForSubagentRequest,
...
async function $do(
  ...
  request: GetSkillsForSubagentRequest,
  options?: RequestOptions & {
    acceptHeaderOverride?: GetSkillsForSubagentAcceptEnum;
  },
): Promise<
  [
    Result<
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetSkillsForSubagentRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc(
    "/manage/tenants/{tenantId}/projects/{projectId}/agents/{agentId}/sub-agent-skills/agent/{subAgentId}",
  )(
    pathParams$,
  );
