 ...
 */
export function dataComponentsCheckDataComponentAgentAssociation(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      CheckDataComponentAgentAssociationRequest$zodSchema.parse(value$),
