 ...
 */
export function externalAgentsDeleteSubAgentExternalAgentRelation(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      DeleteSubAgentExternalAgentRelationRequest$zodSchema.parse(value$),
