...
export enum CheckFunctionToolSubAgentAssociationAcceptEnum {
 ...
 */
export function functionToolsCheckFunctionToolSubAgentAssociation(
  client$: InkeepAgentsCore,
  request: CheckFunctionToolSubAgentAssociationRequest,
...
async function $do(
  ...
  request: CheckFunctionToolSubAgentAssociationRequest,
  options?: RequestOptions & {
    acceptHeaderOverride?: CheckFunctionToolSubAgentAssociationAcceptEnum;
  },
): Promise<
  [
    Result<
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      CheckFunctionToolSubAgentAssociationRequest$zodSchema.parse(value$),
