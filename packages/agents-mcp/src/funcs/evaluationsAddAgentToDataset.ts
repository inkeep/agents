...
import {
  ...
  AddAgentToDatasetRequest$zodSchema,
} from "../models/addagenttodatasetop.js";
...
export enum AddAgentToDatasetAcceptEnum {
  applicationJsonAccept = "application/json",
  applicationProblemPlusJsonAccept = "application/problem+json",
}

/**
 * Add Agent to Dataset
 */
export function evaluationsAddAgentToDataset(
  client$: InkeepAgentsCore,
  request: AddAgentToDatasetRequest,
...
async function $do(
  ...
  request: AddAgentToDatasetRequest,
  options?: RequestOptions & {
    acceptHeaderOverride?: AddAgentToDatasetAcceptEnum;
  },
): Promise<
  [
    Result<
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => AddAgentToDatasetRequest$zodSchema.parse(value$),
