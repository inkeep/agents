 ...
 */
export function artifactComponentsAssociateArtifactComponentWithAgent(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      AssociateArtifactComponentWithAgentRequest$zodSchema.parse(value$),
