 ...
 * Delete SubAgent
 */
export function subAgentsDeleteSubagent(
...
> {
  ...
  const path$ = pathToFunc(
    "/manage/tenants/{tenantId}/projects/{projectId}/agents/{agentId}/sub-agents/{id}",
  )(
    pathParams$,
  );
  ...
  >(
    ...
    M.json([404, 409], DeleteSubagentResponse$zodSchema, {
      key: "ErrorResponse",
    }),
