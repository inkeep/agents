...
import {
  ...
  DeleteSkillFileRequest$zodSchema,
} from "../models/deleteskillfileop.js";
 ...
 * Delete Skill File
 */
export function skillsDeleteSkillFile(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DeleteSkillFileRequest$zodSchema.parse(value$),
