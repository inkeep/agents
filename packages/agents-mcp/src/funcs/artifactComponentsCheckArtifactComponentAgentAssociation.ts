 ...
 */
export function artifactComponentsCheckArtifactComponentAgentAssociation(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      CheckArtifactComponentAgentAssociationRequest$zodSchema.parse(value$),
