 ...
 */
export function contextConfigsGetContextConfigById(
...
> {
  ...
  const path$ = pathToFunc(
    "/manage/tenants/{tenantId}/projects/{projectId}/agents/{agentId}/context-configs/{id}",
  )(
    pathParams$,
  );
