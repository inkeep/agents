 ...
 */
export function externalAgentsUpdateSubAgentExternalAgentRelation(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      UpdateSubAgentExternalAgentRelationRequest$zodSchema.parse(value$),
