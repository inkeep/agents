...
declare const args: {
    request: import("zod").ZodType<import("../../models/checkartifactcomponentagentassociationop.js").CheckArtifactComponentAgentAssociationRequest, import("zod").ZodTypeDef, unknown>;
};
