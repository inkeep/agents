...
declare const args: {
    request: import("zod").ZodType<import("../../models/associateartifactcomponentwithagentop.js").AssociateArtifactComponentWithAgentRequest, import("zod").ZodTypeDef, unknown>;
};
