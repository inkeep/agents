...
declare const args: {
    request: import("zod").ZodType<import("../../models/checkdatacomponentagentassociationop.js").CheckDataComponentAgentAssociationRequest, import("zod").ZodTypeDef, unknown>;
};
