...
export declare const ListToolsStatus$zodSchema: z.ZodEnum<
  ['healthy', 'unhealthy', 'unknown', 'needs_auth']
>;
...
export declare const ListToolsResponse$zodSchema: z.ZodType<
  ListToolsResponse,
  z.ZodTypeDef,
  unknown
>;
