...
import { UpdateFullAgentRequest$zodSchema, UpdateFullAgentResponse$zodSchema, } from "../models/updatefullagentop.js";
import { APIPromise } from "../types/async.js";
export var UpdateFullAgentAcceptEnum;
(function (UpdateFullAgentAcceptEnum) {
    UpdateFullAgentAcceptEnum["applicationJsonAccept"] = "application/json";
    UpdateFullAgentAcceptEnum["applicationProblemPlusJsonAccept"] = "application/problem+json";
})(UpdateFullAgentAcceptEnum || (UpdateFullAgentAcceptEnum = {}));
/**
 * Update Full Agent
 *
 * @remarks
 ...
 */
export function fullAgentUpdateFullAgent(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => UpdateFullAgentRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
    ...
    const [result$] = await M.match(M.json([200, 201], UpdateFullAgentResponse$zodSchema, {
