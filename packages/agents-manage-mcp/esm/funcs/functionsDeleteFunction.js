...
import { DeleteFunctionRequest$zodSchema, DeleteFunctionResponse$zodSchema, } from "../models/deletefunctionop.js";
...
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => DeleteFunctionRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
    ...
    const [result$] = await M.match(M.nil(204, DeleteFunctionResponse$zodSchema), M.json(400, DeleteFunctionResponse$zodSchema, {
