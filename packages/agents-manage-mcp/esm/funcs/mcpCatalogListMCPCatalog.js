...
import { ListMcpCatalogRequest$zodSchema, ListMcpCatalogResponse$zodSchema, } from "../models/listmcpcatalogop.js";
import { APIPromise } from "../types/async.js";
export var ListMcpCatalogAcceptEnum;
(function (ListMcpCatalogAcceptEnum) {
    ListMcpCatalogAcceptEnum["applicationJsonAccept"] = "application/json";
    ListMcpCatalogAcceptEnum["applicationProblemPlusJsonAccept"] = "application/problem+json";
})(ListMcpCatalogAcceptEnum || (ListMcpCatalogAcceptEnum = {}));
/**
 ...
 */
export function mcpCatalogListMCPCatalog(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => ListMcpCatalogRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
    ...
    const [result$] = await M.match(M.json(200, ListMcpCatalogResponse$zodSchema, {
