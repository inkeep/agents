...
import { GetFullAgentRequest$zodSchema, GetFullAgentResponse$zodSchema, } from "../models/getfullagentop.js";
import { APIPromise } from "../types/async.js";
export var GetFullAgentAcceptEnum;
(function (GetFullAgentAcceptEnum) {
    GetFullAgentAcceptEnum["applicationJsonAccept"] = "application/json";
    GetFullAgentAcceptEnum["applicationProblemPlusJsonAccept"] = "application/problem+json";
})(GetFullAgentAcceptEnum || (GetFullAgentAcceptEnum = {}));
/**
 * Get Full Agent
 *
 * @remarks
 ...
 */
export function fullAgentGetFullAgent(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => GetFullAgentRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
    ...
    const [result$] = await M.match(M.json(200, GetFullAgentResponse$zodSchema, {
