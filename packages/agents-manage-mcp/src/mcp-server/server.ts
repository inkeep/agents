...
import { tool$cliGetApiCliMe } from './tools/cliGetApiCliMe.js';
...
import { tool$invitationsGetApiInvitationsPending } from './tools/invitationsGetApiInvitationsPending.js';
...
import { tool$userOrganizationsGetApiUsersUserIdOrganizations } from './tools/userOrganizationsGetApiUsersUserIdOrganizations.js';
import { tool$userOrganizationsPostApiUsersUserIdOrganizations } from './tools/userOrganizationsPostApiUsersUserIdOrganizations.js';
...
export function createMCPServer(deps: {
  ...
  tool(tool$health);
  tool(tool$userOrganizationsGetApiUsersUserIdOrganizations);
  tool(tool$userOrganizationsPostApiUsersUserIdOrganizations);
  tool(tool$cliGetApiCliMe);
  tool(tool$invitationsGetApiInvitationsPending);
  ...
  // Attach tool metadata for optional introspection while still returning the
  // MCP server instance (which exposes .connect used by consumers).
  (server as any).tools = tools;
  return server;
}
