...
export const tool$subAgentToolRelationsGetSubagentToolRelation: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] =
      await subAgentToolRelationsGetSubagentToolRelation(
        client,
        args.request,
