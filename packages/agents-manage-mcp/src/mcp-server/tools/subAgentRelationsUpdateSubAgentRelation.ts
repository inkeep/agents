...
export const tool$subAgentRelationsUpdateSubAgentRelation: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await subAgentRelationsUpdateSubAgentRelation(
      client,
      args.request,
