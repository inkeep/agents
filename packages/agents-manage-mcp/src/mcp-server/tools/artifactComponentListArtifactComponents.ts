...
export const tool$artifactComponentListArtifactComponents: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await artifactComponentListArtifactComponents(
      client,
      args.request,
