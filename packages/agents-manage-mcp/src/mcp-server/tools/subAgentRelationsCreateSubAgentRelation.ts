...
export const tool$subAgentRelationsCreateSubAgentRelation: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await subAgentRelationsCreateSubAgentRelation(
      client,
      args.request,
