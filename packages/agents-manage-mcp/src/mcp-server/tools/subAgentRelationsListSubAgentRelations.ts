...
export const tool$subAgentRelationsListSubAgentRelations: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await subAgentRelationsListSubAgentRelations(
      client,
      args.request,
