...
export const tool$artifactComponentUpdateArtifactComponent: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await artifactComponentUpdateArtifactComponent(
      client,
      args.request,
