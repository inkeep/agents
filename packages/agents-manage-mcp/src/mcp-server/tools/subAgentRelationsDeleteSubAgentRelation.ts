...
export const tool$subAgentRelationsDeleteSubAgentRelation: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await subAgentRelationsDeleteSubAgentRelation(
      client,
      args.request,
