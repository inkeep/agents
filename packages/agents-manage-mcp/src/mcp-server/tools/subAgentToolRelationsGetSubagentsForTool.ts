...
export const tool$subAgentToolRelationsGetSubagentsForTool: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await subAgentToolRelationsGetSubagentsForTool(
      client,
      args.request,
