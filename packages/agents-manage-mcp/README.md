...
<div align="left" style="margin-bottom: 0;">
    <a href="https://www.speakeasy.com/?utm_source=@inkeep/agents-manage-mcp&utm_campaign=mcp-typescript" class="badge-link">
...
[![Install MCP Server](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/install-mcp?name=InkeepAgents&config=eyJtY3BTZXJ2ZXJzIjp7Iklua2VlcEFnZW50cyI6eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAaW5rZWVwL2FnZW50cy1tYW5hZ2UtbWNwIiwic3RhcnQiXX19fQ==)
...
```bash
claude mcp add @inkeep/agents-manage-mcp npx @inkeep/agents-manage-mcp start --
```
...
```bash
npx @inkeep/agents-manage-mcp start
```
