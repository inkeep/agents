...
export declare function encodeMatrix(
  key: string,
  value: unknown,
  options?: {
    explode?: boolean;
...
export declare function encodeLabel(
  key: string,
  value: unknown,
  options?: {
    explode?: boolean;
...
export declare function encodeBodyForm(
  key: string,
  value: unknown,
  options?: {
    explode?: boolean;
...
export declare function encodeDeepObject(
  key: string,
  value: unknown,
  options?: {
    charEncoding?: 'percent' | 'none';
...
export declare function encodeDeepObjectObject(
  key: string,
  value: unknown,
  options?: {
    charEncoding?: 'percent' | 'none';
...
export declare function encodeJSON(
  key: string,
  value: unknown,
  options?: {
    explode?: boolean;
...
export declare const encodeSimple: (
  key: string,
  value: unknown,
  options?: {
    explode?: boolean;
...
export declare function appendForm(
  fd: FormData,
  key: string,
  value: unknown,
  fileName?: string
