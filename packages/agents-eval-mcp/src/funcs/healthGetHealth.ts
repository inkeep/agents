...
import { GetHealthResponse, GetHealthResponse$zodSchema } from '../models/gethealthop.js';
...
> {
  ...
  const [result$] = await M.match<
    ...
    | RequestTimeoutError
    | ConnectionError
  >(M.nil(204, GetHealthResponse$zodSchema))(response, req$, { extraFields: responseFields$ });
