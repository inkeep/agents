 ...
 */
export interface SlackUserAuthContext {
  userId: string;
  tenantId: string;
  source: 'slack';
  metadata: {
 ...
 */
export async function verifySlackUserAuthHeader(
  authHeader: string | undefined
): Promise<VerifySlackUserTokenResult> {
 ...
 */
export function toSlackUserAuthContext(payload: SlackAccessTokenPayload): SlackUserAuthContext {
  return {
    userId: payload.sub,
