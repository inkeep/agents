...
/* =============================================================================
 * Helper function to read numeric env var with fallback
 * ============================================================================= */
...
export const AGENT_EXECUTION_TRANSFER_COUNT_MIN = getEnvNumber(
  'AGENTS_AGENT_EXECUTION_TRANSFER_COUNT_MIN',
  1
);
...
export const AGENT_EXECUTION_TRANSFER_COUNT_MAX = getEnvNumber(
  'AGENTS_AGENT_EXECUTION_TRANSFER_COUNT_MAX',
  1000
);
...
export const AGENT_EXECUTION_TRANSFER_COUNT_DEFAULT = getEnvNumber(
  'AGENTS_EXECUTION_TRANSFER_COUNT_DEFAULT',
  10
);
...
export const AGENT_EXECUTION_MAX_CONSECUTIVE_ERRORS = getEnvNumber(
  'AGENTS_EXECUTION_MAX_CONSECUTIVE_ERRORS',
  3
);
...
export const SUB_AGENT_TURN_GENERATION_STEPS_MIN = getEnvNumber(
  'AGENTS_SUB_AGENT_TURN_GENERATION_STEPS_MIN',
  1
);
...
export const SUB_AGENT_TURN_GENERATION_STEPS_MAX = getEnvNumber(
  'AGENTS_SUB_AGENT_TURN_GENERATION_STEPS_MAX',
  1000
);
...
export const SUB_AGENT_TURN_GENERATION_STEPS_DEFAULT = getEnvNumber(
  'AGENTS_SUB_AGENT_TURN_GENERATION_STEPS_DEFAULT',
  12
);
...
export const LLM_GENERATION_FIRST_CALL_TIMEOUT_MS_STREAMING = getEnvNumber(
  'AGENTS_LLM_GENERATION_FIRST_CALL_TIMEOUT_MS_STREAMING',
  270_000 // 4.5 minutes
);
...
export const LLM_GENERATION_FIRST_CALL_TIMEOUT_MS_NON_STREAMING = getEnvNumber(
  'AGENTS_LLM_GENERATION_FIRST_CALL_TIMEOUT_MS_NON_STREAMING',
  90_000 // 1.5 minutes
);
...
export const LLM_GENERATION_SUBSEQUENT_CALL_TIMEOUT_MS = getEnvNumber(
  'AGENTS_LLM_GENERATION_SUBSEQUENT_CALL_TIMEOUT_MS',
  90_000 // 1.5 minutes
);
...
export const LLM_GENERATION_MAX_ALLOWED_TIMEOUT_MS = getEnvNumber(
  'AGENTS_LLM_GENERATION_MAX_ALLOWED_TIMEOUT_MS',
  600_000 // 10 minutes
);
...
export const FUNCTION_TOOL_EXECUTION_TIMEOUT_MS_DEFAULT = getEnvNumber(
  'AGENTS_FUNCTION_TOOL_EXECUTION_TIMEOUT_MS_DEFAULT',
  30_000 // 30 seconds
);
...
export const FUNCTION_TOOL_SANDBOX_VCPUS_DEFAULT = getEnvNumber(
  'AGENTS_FUNCTION_TOOL_SANDBOX_VCPUS_DEFAULT',
  4
);
...
export const FUNCTION_TOOL_SANDBOX_POOL_TTL_MS = getEnvNumber(
  'AGENTS_FUNCTION_TOOL_SANDBOX_POOL_TTL_MS',
  300_000 // 5 minutes
);
...
export const FUNCTION_TOOL_SANDBOX_MAX_USE_COUNT = getEnvNumber(
  'AGENTS_FUNCTION_TOOL_SANDBOX_MAX_USE_COUNT',
  50
);
...
export const FUNCTION_TOOL_SANDBOX_MAX_OUTPUT_SIZE_BYTES = getEnvNumber(
  'AGENTS_FUNCTION_TOOL_SANDBOX_MAX_OUTPUT_SIZE_BYTES',
  1_048_576 // 1 MB
);
...
export const FUNCTION_TOOL_SANDBOX_QUEUE_WAIT_TIMEOUT_MS = getEnvNumber(
  'AGENTS_FUNCTION_TOOL_SANDBOX_QUEUE_WAIT_TIMEOUT_MS',
  30_000 // 30 seconds
);
...
export const FUNCTION_TOOL_SANDBOX_CLEANUP_INTERVAL_MS = getEnvNumber(
  'AGENTS_FUNCTION_TOOL_SANDBOX_CLEANUP_INTERVAL_MS',
  60_000 // 1 minute
);
...
export const MCP_TOOL_REQUEST_TIMEOUT_MS_DEFAULT = getEnvNumber(
  'AGENTS_MCP_TOOL_REQUEST_TIMEOUT_MS_DEFAULT',
  60_000 // 60 seconds
);
...
export const MCP_TOOL_CONNECTION_TIMEOUT_MS = getEnvNumber(
  'AGENTS_MCP_TOOL_CONNECTION_TIMEOUT_MS',
  3_000 // 3 seconds
);
...
export const MCP_TOOL_MAX_RETRIES = getEnvNumber('AGENTS_MCP_TOOL_MAX_RETRIES', 3);
...
export const MCP_TOOL_MAX_RECONNECTION_DELAY_MS = getEnvNumber(
  'AGENTS_MCP_TOOL_MAX_RECONNECTION_DELAY_MS',
  30_000 // 30 seconds
);
...
export const MCP_TOOL_INITIAL_RECONNECTION_DELAY_MS = getEnvNumber(
  'AGENTS_MCP_TOOL_INITIAL_RECONNECTION_DELAY_MS',
  1_000 // 1 second
);
...
export const MCP_TOOL_RECONNECTION_DELAY_GROWTH_FACTOR = getEnvNumber(
  'AGENTS_MCP_TOOL_RECONNECTION_DELAY_GROWTH_FACTOR',
  1.5
);
...
export const DELEGATION_TOOL_BACKOFF_INITIAL_INTERVAL_MS = getEnvNumber(
  'AGENTS_DELEGATION_TOOL_BACKOFF_INITIAL_INTERVAL_MS',
  100
);
...
export const DELEGATION_TOOL_BACKOFF_MAX_INTERVAL_MS = getEnvNumber(
  'AGENTS_DELEGATION_TOOL_BACKOFF_MAX_INTERVAL_MS',
  10_000 // 10 seconds
);
...
export const DELEGATION_TOOL_BACKOFF_EXPONENT = getEnvNumber(
  'AGENTS_DELEGATION_TOOL_BACKOFF_EXPONENT',
  2
);
...
export const DELEGATION_TOOL_BACKOFF_MAX_ELAPSED_TIME_MS = getEnvNumber(
  'AGENTS_DELEGATION_TOOL_BACKOFF_MAX_ELAPSED_TIME_MS',
  20_000 // 20 seconds
);
...
export const A2A_BACKOFF_INITIAL_INTERVAL_MS = getEnvNumber(
  'AGENTS_A2A_BACKOFF_INITIAL_INTERVAL_MS',
  500
);
...
export const A2A_BACKOFF_MAX_INTERVAL_MS = getEnvNumber(
  'AGENTS_A2A_BACKOFF_MAX_INTERVAL_MS',
  60_000 // 1 minute
);
...
export const A2A_BACKOFF_EXPONENT = getEnvNumber('AGENTS_A2A_BACKOFF_EXPONENT', 1.5);

// Total maximum time for general A2A retries before giving up
// Used by: a2a/client.ts default backoff config
// Env: AGENTS_A2A_BACKOFF_MAX_ELAPSED_TIME_MS
export const A2A_BACKOFF_MAX_ELAPSED_TIME_MS = getEnvNumber(
  'AGENTS_A2A_BACKOFF_MAX_ELAPSED_TIME_MS',
  30_000 // 30 seconds
);
...
export const ARTIFACT_GENERATION_MAX_RETRIES = getEnvNumber(
  'AGENTS_ARTIFACT_GENERATION_MAX_RETRIES',
  3
);
...
export const ARTIFACT_SESSION_MAX_PENDING = getEnvNumber(
  'AGENTS_ARTIFACT_SESSION_MAX_PENDING',
  100
);
...
export const ARTIFACT_SESSION_MAX_PREVIOUS_SUMMARIES = getEnvNumber(
  'AGENTS_ARTIFACT_SESSION_MAX_PREVIOUS_SUMMARIES',
  3
);
...
export const ARTIFACT_GENERATION_BACKOFF_INITIAL_MS = getEnvNumber(
  'AGENTS_ARTIFACT_GENERATION_BACKOFF_INITIAL_MS',
  1_000 // 1 second
);
...
export const ARTIFACT_GENERATION_BACKOFF_MAX_MS = getEnvNumber(
  'AGENTS_ARTIFACT_GENERATION_BACKOFF_MAX_MS',
  10_000 // 10 seconds
);
...
export const SESSION_TOOL_RESULT_CACHE_TIMEOUT_MS = getEnvNumber(
  'AGENTS_SESSION_TOOL_RESULT_CACHE_TIMEOUT_MS',
  300_000 // 5 minutes
);
...
export const SESSION_CLEANUP_INTERVAL_MS = getEnvNumber(
  'AGENTS_SESSION_CLEANUP_INTERVAL_MS',
  60_000 // 1 minute
);
...
export const STATUS_UPDATE_DEFAULT_NUM_EVENTS = getEnvNumber(
  'AGENTS_STATUS_UPDATE_DEFAULT_NUM_EVENTS',
  1
);
...
export const STATUS_UPDATE_DEFAULT_INTERVAL_SECONDS = getEnvNumber(
  'AGENTS_STATUS_UPDATE_DEFAULT_INTERVAL_SECONDS',
  2
);
...
export const STATUS_UPDATE_MAX_NUM_EVENTS = getEnvNumber(
  'AGENTS_STATUS_UPDATE_MAX_NUM_EVENTS',
  100
);
...
export const STATUS_UPDATE_MAX_INTERVAL_SECONDS = getEnvNumber(
  'AGENTS_STATUS_UPDATE_MAX_INTERVAL_SECONDS',
  600 // 10 minutes
);
...
export const STREAM_PARSER_MAX_SNAPSHOT_SIZE = getEnvNumber(
  'AGENTS_STREAM_PARSER_MAX_SNAPSHOT_SIZE',
  100
);
...
export const STREAM_PARSER_MAX_STREAMED_SIZE = getEnvNumber(
  'AGENTS_STREAM_PARSER_MAX_STREAMED_SIZE',
  1000
);
...
export const STREAM_PARSER_MAX_COLLECTED_PARTS = getEnvNumber(
  'AGENTS_STREAM_PARSER_MAX_COLLECTED_PARTS',
  10_000
);
...
export const STREAM_BUFFER_MAX_SIZE_BYTES = getEnvNumber(
  'AGENTS_STREAM_BUFFER_MAX_SIZE_BYTES',
  5_242_880 // 5 MB
);
...
export const STREAM_TEXT_GAP_THRESHOLD_MS = getEnvNumber(
  'AGENTS_STREAM_TEXT_GAP_THRESHOLD_MS',
  2_000 // 2 seconds
);
...
export const STREAM_MAX_LIFETIME_MS = getEnvNumber(
  'AGENTS_STREAM_MAX_LIFETIME_MS',
  600_000 // 10 minutes
);
...
export const VALIDATION_SUB_AGENT_PROMPT_MAX_CHARS = getEnvNumber(
  'AGENTS_VALIDATION_SUB_AGENT_PROMPT_MAX_CHARS',
  2_000
);
...
export const VALIDATION_AGENT_PROMPT_MAX_CHARS = getEnvNumber(
  'AGENTS_VALIDATION_AGENT_PROMPT_MAX_CHARS',
  5_000
);
...
export const VALIDATION_PAGINATION_MAX_LIMIT = getEnvNumber(
  'AGENTS_VALIDATION_PAGINATION_MAX_LIMIT',
  100
);
...
export const VALIDATION_PAGINATION_DEFAULT_LIMIT = getEnvNumber(
  'AGENTS_VALIDATION_PAGINATION_DEFAULT_LIMIT',
  50
);
...
export const DATA_COMPONENT_FETCH_TIMEOUT_MS_DEFAULT = getEnvNumber(
  'AGENTS_DATA_COMPONENT_FETCH_TIMEOUT_MS_DEFAULT',
  10_000 // 10 seconds
);
...
export const CONVERSATION_HISTORY_DEFAULT_LIMIT = getEnvNumber(
  'AGENTS_CONVERSATION_HISTORY_DEFAULT_LIMIT',
  50
);
