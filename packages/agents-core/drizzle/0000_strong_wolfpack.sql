CREATE TABLE "agent" (
	...
	"description" text,
	"default_sub_agent_id" varchar(255),
	"context_config_id" varchar(255),
	"models" jsonb,
	...
	CONSTRAINT "agent_pk" PRIMARY KEY("tenant_id","project_id","id")
);
...
CREATE TABLE "artifact_components" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "artifact_components_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
CREATE TABLE "context_cache" (
	...
	"context_config_id" varchar(255) NOT NULL,
	"context_variable_key" varchar(255) NOT NULL,
	"value" jsonb NOT NULL,
	"request_hash" varchar(255),
	"fetched_at" timestamp NOT NULL,
	"fetch_source" varchar(255),
	"fetch_duration_ms" integer,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "context_cache_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
CREATE TABLE "context_configs" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "context_configs_pk" PRIMARY KEY("tenant_id","project_id","agent_id","id")
);
--> statement-breakpoint
CREATE TABLE "conversations" (
	...
	"project_id" varchar(255) NOT NULL,
	"user_id" varchar(255),
	"active_sub_agent_id" varchar(255) NOT NULL,
	"title" text,
	"last_context_resolution" text,
	"metadata" jsonb,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "conversations_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
CREATE TABLE "credential_references" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "credential_references_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
CREATE TABLE "data_components" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "data_components_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
CREATE TABLE "external_agents" (
	...
	"credential_reference_id" varchar(255),
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "external_agents_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
CREATE TABLE "function_tools" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "function_tools_pk" PRIMARY KEY("tenant_id","project_id","agent_id","id")
);
--> statement-breakpoint
CREATE TABLE "functions" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "functions_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
CREATE TABLE "ledger_artifacts" (
	...
	"type" varchar(255) DEFAULT 'source' NOT NULL,
	"name" varchar(255),
	"description" text,
	"parts" jsonb,
	"metadata" jsonb,
	"summary" text,
	"mime" jsonb,
	"visibility" varchar(255) DEFAULT 'context',
	"allowed_agents" jsonb,
	"derived_from" varchar(255),
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "ledger_artifacts_pk" PRIMARY KEY("tenant_id","project_id","id","task_id"),
...
CREATE TABLE "messages" (
	...
	"from_sub_agent_id" varchar(255),
	"to_sub_agent_id" varchar(255),
	"from_external_sub_agent_id" varchar(255),
	"to_external_sub_agent_id" varchar(255),
	"from_team_agent_id" varchar(255),
	"to_team_agent_id" varchar(255),
	"content" jsonb NOT NULL,
	"visibility" varchar(255) DEFAULT 'user-facing' NOT NULL,
	"message_type" varchar(255) DEFAULT 'chat' NOT NULL,
	"task_id" varchar(255),
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "messages_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
CREATE TABLE "projects" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "projects_pk" PRIMARY KEY("tenant_id","id")
);
--> statement-breakpoint
CREATE TABLE "sub_agent_artifact_components" (
	...
	"artifact_component_id" varchar(255) NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "sub_agent_data_components" (
	...
	"agent_id" varchar(255) NOT NULL,
	"sub_agent_id" varchar(255) NOT NULL,
	"data_component_id" varchar(255) NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "sub_agent_data_components_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
...
CREATE TABLE "sub_agent_function_tool_relations" (
	...
	"agent_id" varchar(255) NOT NULL,
	"sub_agent_id" varchar(255) NOT NULL,
	"function_tool_id" varchar(255) NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "sub_agent_relations" (
	...
	"project_id" varchar(255) NOT NULL,
	"agent_id" varchar(255) NOT NULL,
	"source_sub_agent_id" varchar(255) NOT NULL,
	"target_sub_agent_id" varchar(255),
	"relation_type" varchar(255),
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "sub_agent_relations_pk" PRIMARY KEY("tenant_id","project_id","agent_id","id")
);
--> statement-breakpoint
...
CREATE TABLE "sub_agent_tool_relations" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "sub_agent_tool_relations_pk" PRIMARY KEY("tenant_id","project_id","agent_id","id")
);
--> statement-breakpoint
CREATE TABLE "sub_agents" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "sub_agents_pk" PRIMARY KEY("tenant_id","project_id","agent_id","id")
);
--> statement-breakpoint
CREATE TABLE "task_relations" (
	...
	"child_task_id" varchar(255) NOT NULL,
	"relation_type" varchar(255) DEFAULT 'parent_child',
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "task_relations_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
CREATE TABLE "tasks" (
	"tenant_id" varchar(255) NOT NULL,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "tasks_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
CREATE TABLE "tools" (
	"tenant_id" varchar(255) NOT NULL,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "tools_pk" PRIMARY KEY("tenant_id","project_id","id")
);
--> statement-breakpoint
