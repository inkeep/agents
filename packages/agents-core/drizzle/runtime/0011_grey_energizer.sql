...
--> statement-breakpoint
CREATE TABLE "work_app_slack_user_settings" (
	"id" varchar(256) PRIMARY KEY NOT NULL,
	"tenant_id" varchar(256) NOT NULL,
	"slack_team_id" varchar(256) NOT NULL,
	"slack_user_id" varchar(256) NOT NULL,
	...
	"default_agent_name" varchar(256),
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "work_app_slack_user_settings_unique" UNIQUE("tenant_id","slack_team_id","slack_user_id")
);
--> statement-breakpoint
...
ALTER TABLE "work_app_slack_user_settings" ADD CONSTRAINT "work_app_slack_user_settings_tenant_id_organization_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "work_app_slack_user_settings_tenant_idx" ON "work_app_slack_user_settings" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "work_app_slack_user_settings_team_idx" ON "work_app_slack_user_settings" USING btree ("slack_team_id");--> statement-breakpoint
CREATE INDEX "work_app_slack_user_settings_user_idx" ON "work_app_slack_user_settings" USING btree ("slack_user_id");--> statement-breakpoint
