...
const SheetOverlay: FC<ComponentProps<typeof SheetPrimitive.Overlay>> = ({
  ...
  <SheetPrimitive.Overlay
    className={cn(
      'fixed inset-0 z-50 bg-black/20 backdrop-blur-sm dark:bg-gray-900/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className
    )}
    {...props}
  />
