...
| `SPICEDB_TLS_ENABLED` | No | Explicitly enable/disable TLS (default: auto-detect based on endpoint) |
...
<Steps>
  ...
  <Step>
    ...
    # SPICEDB_TLS_ENABLED=  # Optional: explicitly set TLS (auto-detected by default)
    ```
  </Step>
  <Step>
    ### Restart services
