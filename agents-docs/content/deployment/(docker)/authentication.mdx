...
<Steps>
  ...
  <Step>
    ...
    Open http://localhost:3000. In local development, you'll be signed in automatically using the credentials configured above. In production deployments, sign in manually with your admin credentials.
  </Step>
</Steps>
