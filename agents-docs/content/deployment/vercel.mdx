...
# Bot Protection (ALTCHA Sentinel)
INKEEP_SENTINEL_API_KEY_ID=
INKEEP_SENTINEL_API_KEY_SECRET=
INKEEP_SENTINEL_BASE_URL=https://challenges.inkeep.com
...
| `INKEEP_SENTINEL_API_KEY_ID`          | API key ID for [ALTCHA Sentinel](https://altcha.org/sentinel) bot protection. Required for production deployments using the embedded chat widget with anonymous sessions.                                                                   |
| `INKEEP_SENTINEL_API_KEY_SECRET`      | API key secret for ALTCHA Sentinel bot protection (min 32 chars). Generate or retrieve from your Sentinel dashboard.                                                                                                                        |
| `INKEEP_SENTINEL_BASE_URL`            | `https://challenges.inkeep.com`                                                                                                                                                                                                            |
