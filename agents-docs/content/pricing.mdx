...
<OptionCards>
  ...
  <OptionCard title="Enterprise" icon="LuBuilding" href="https://inkeep.com/demo" subtitle="Everything in Open Source plus:" badge="Contact Us" highlighted cta="Schedule a Demo">
