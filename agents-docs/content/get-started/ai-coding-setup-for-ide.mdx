---
title: Add Inkeep Skills and MCP Server to your IDE or coding tools
sidebarTitle: AI Coding Setup
description: Install Skills and MCP to help AI coding assistants build Inkeep agents.
icon: "brand/Inkeep"
---
