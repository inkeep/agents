...
<Note>
  By default, the retention period for conversation data and traces is **15 days**. To configure a longer retention period, navigate to **Settings → General** in SigNoz.
</Note>
