...
_openapi:
  ...
  structuredData:
    ...
    contents:
      - content: >-
          Redirects to Slack OAuth page for workspace installation. Pass
          include_webhook=true to additionally request the incoming-webhook
          scope (shows channel picker for webhook URL).
      ...
      - content: >-
          Uninstall the Inkeep Slack app from a workspace. The path parameter
          must be the raw Slack team ID (e.g. T012AB3C4).
        heading: uninstall-workspace
      - content: List Slack channels where the bot is a member
