...
5. If denied, the agent receives a clean human-readable denial reason string, allowing it to understand why the request was denied and adapt its behavior (for example, trying a different approach or asking a clarifying question)
