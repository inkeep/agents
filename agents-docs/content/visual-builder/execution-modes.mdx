...
- Pending tool approvals are persisted to workflow metadata and can be recovered via the [pending approvals endpoint](/talk-to-your-agents/chat-api#recovering-pending-approvals) after stream disconnection or page refresh
