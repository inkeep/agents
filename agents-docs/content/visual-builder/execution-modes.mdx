...
Set the `executionMode` in the agent configuration when creating an agent programmatically:
...
This sets the default execution mode for all requests to this agent.
