...
<NumberedStepsTOC stepIds={["go-to-the-triggers-menu", "click-on-the-webhooks-tab", "click-on-new-webhook-trigger"]} />

<Steps>
  <Step>
    ### Go to the Triggers menu

    Navigate to the Triggers menu item in the left sidebar.
