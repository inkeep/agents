...
Webhook deliveries include any **custom headers** you configure on the destination. Header names and values are validated on save:

| Constraint | Limit |
| --- | --- |
| **Name charset** | RFC 7230 token characters: alphanumeric plus ``!#$%&'*+-.^_`|~`` |
| **Name length** | 1–128 characters |
| **Value length** | 1–1,000 characters |
