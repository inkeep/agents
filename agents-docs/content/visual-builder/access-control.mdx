...
| **Microsoft** | OAuth sign-in via Microsoft Entra ID (requires configuration) |

To add OAuth sign-in providers, see [Google OAuth](/deployment/authentication#google-oauth) and [Microsoft Entra ID](/deployment/authentication#microsoft-entra-id).
