...
4. Click the link and set a new password that meets the [password requirements](/deployment/authentication#invalid-credentials-on-first-login)

The reset link expires after 30 minutes. If you don't receive the email, check your spam folder.

<Tip>
  New passwords must be at least 15 characters and include uppercase, lowercase, digit, and special character. The form shows live feedback as you type.
</Tip>
