...
| Role | Permissions |
|------|-------------|
| **Owner** | Supreme organization role. Full access to all projects and settings, can manage all members including admins |
| **Admin** | Full access to all projects and settings, can manage members (except owners) |
...
4. Select a role (Owner, Admin, or Member) for the new team member
