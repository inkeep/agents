...
1. Go to **Members** in the left sidebar (under Organization)
2. View current members, their roles, and pending invitations
3. Type email addresses in the invite bar and click **Add**
4. Select a role (Admin or Member) and sign-in method for the new members
5. To remove a member, click the actions menu on their row and select **Remove from organization**
