...
| Role | Permissions |
|------|-------------|
| **Admin** | Full access to all projects and settings, can add and remove members |
...
1. Go to **Settings** in the left sidebar
2. Click the actions menu (**⋮**) next to the member you want to remove
3. Select **Delete member**
4. Confirm the deletion in the modal

Deleting a member permanently removes them from the organization and revokes their access to all projects.

<Note>
  You cannot delete yourself or the organization owner. Only organization Admins can delete members.
</Note>

#### Revoking Invitations

1. Go to **Settings** in the left sidebar
2. Click the actions menu (**⋮**) next to the pending invitation
3. Select **Revoke invite**
4. Confirm the revocation in the modal

Revoking an invitation prevents the recipient from accepting it. You can send a new invitation if needed.
