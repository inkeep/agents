...
3. Fill in:
   ...
   - **Pass criteria** (optional) — conditions that define pass/fail. Supports numeric comparisons (e.g. `score >= 0.8`) and boolean checks (e.g. `passed = true`). Conditions can be nested with AND/OR operators for complex logic.
