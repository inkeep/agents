...
The toolbar also includes a **View Traces** button to quickly access traces filtered for this agent. See [Traces](/get-started/traces) for more details on debugging with traces.
