...
Use the menu on an existing agent card and choose **Duplicate**.
...
If you keep **Target project** set to the current project, the copied agent stays within that
project.
...
If you change **Target project** to a different project, the builder copies the selected agent into
that project instead. Cross-project copies always read from the source project's main branch.
