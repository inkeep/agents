...
|----------|----------------|---------|
| **Anthropic** | `anthropic/claude-opus-4-8`<br/>`anthropic/claude-opus-4-7`<br/>`anthropic/claude-opus-4-6`<br/>`anthropic/claude-sonnet-4-6`<br/>`anthropic/claude-sonnet-4-5`<br/>`anthropic/claude-haiku-4-5` | `ANTHROPIC_API_KEY` |
