...
Both features can be used together. This tries `claude-sonnet-4-5` via Bedrock, then Anthropic. If both fail, it falls through to the fallback models in order:
