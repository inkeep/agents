...
<Tip>
The model list is automatically updated daily. A scheduled GitHub Action detects new models from Anthropic, OpenAI, and Google APIs and opens PRs to add them, ensuring the SDK stays current with the latest releases.
</Tip>
