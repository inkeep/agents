...
<Tip>
The `echo/` provider (`echo/default`, `echo/any-name`) returns deterministic responses without API calls or keys. Use it for testing and CI/CD. It supports both streaming and non-streaming and returns synthetic token usage.
</Tip>
