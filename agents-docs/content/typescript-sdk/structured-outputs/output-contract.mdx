...
<Note>
Using the Visual Builder? The same contract is configured visually in a sub agent's [Guardrails](/visual-builder/structured-outputs/output-contract) section.
</Note>
