---
title: Context Fetchers in TypeScript SDK
sidebarTitle: Context Fetchers
description: Define context fetchers in the TypeScript SDK to pull real-time data from external APIs into agent prompts.
icon: LuCirclePlus
---
...
<SkillRule
  id="context-fetchers-overview"
  skills="typescript-sdk"
  title="Context Fetchers Overview"
  description="How to use context fetchers to embed real-time data in agent prompts"
>
