...
sidebarTitle: Nango
description: Set up Nango as an OAuth-capable credential store for your Inkeep agents.
icon: "brand/Nango"
---
...
Open **Credentials** in the Visual Builder and select **New credential**. Choose a credential type, complete the form, select **Nango Store** as the credential store, then select **Create Credential**. See [Manage credentials in Visual Builder](/visual-builder/tools/credentials) for more information.
