...
- `--ui [component-id]` - Add a data or artifact UI component to your app. Use the component id from the dashboard. Omit the id to see available components. Use `--target-path` to specify the output directory.
