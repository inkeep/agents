...
- `--profile <name>` - Use a specific CLI profile (overrides the active profile)
- `--quiet` - Suppress interactive prompts and extra logs
- `--conflict-strategy <ours|theirs>` - Auto-resolve merge conflicts without interactive prompts. `ours` keeps local values, `theirs` accepts remote values
...
# Auto-resolve merge conflicts keeping local changes
inkeep pull --conflict-strategy ours

# Auto-resolve merge conflicts keeping remote changes
...
<SkillRule
  id="cli-logout-command"
  skills="typescript-sdk"
  title="CLI inkeep logout Command"
...
<SkillRule
  id="cli-environment-variables"
  skills="typescript-sdk"
  title="CLI Environment Variables"
  description="Environment variables respected by the CLI and SDK"
>
