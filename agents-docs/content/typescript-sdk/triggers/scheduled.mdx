...
See [Execution Identity](/talk-to-your-agents/triggers/scheduled#set-the-execution-identity) for details on permissions, admin delegation, and runtime behavior.
