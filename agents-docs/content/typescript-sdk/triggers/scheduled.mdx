...
See [User-Scoped Execution](/talk-to-your-agents/triggers/scheduled#user-scoped-execution) for details on permissions, admin delegation, and runtime behavior.
