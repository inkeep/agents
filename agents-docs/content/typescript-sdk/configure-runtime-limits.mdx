...
<SkillRule
  id="runtime-limits-overview"
  skills="typescript-sdk"
  title="Runtime Limits Configuration"
  description="How to configure execution limits, timeouts, and constraints"
>
...
- **Prompt Validation**: Agent and sub-agent system prompts share a 200,000-character limit (override via `AGENTS_VALIDATION_AGENT_PROMPT_MAX_CHARS`). The status-update custom-prompt limit remains at 2,000 characters.
