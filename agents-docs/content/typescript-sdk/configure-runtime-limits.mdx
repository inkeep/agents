...
- **Prompt Validation**: Character limits for agent and sub-agent system prompts (default: 100,000 characters each, overridable via `AGENTS_VALIDATION_AGENT_PROMPT_MAX_CHARS`)
