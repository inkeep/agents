...
<Note>
For time-based automation (cron schedules or one-time runs), see [Scheduled Triggers](/typescript-sdk/scheduled-triggers).
</Note>
...
<Cards>
  <Card title="Scheduled Triggers" icon="LuClock" href="/typescript-sdk/scheduled-triggers">
    Run agents on a schedule using cron expressions or one-time execution.
  </Card>
</Cards>
