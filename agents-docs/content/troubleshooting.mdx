...
- **MCP server creation hangs or appears unresponsive**:
    - Ensure you have made an active selection in the **Credentials** dropdown
    - Select **No Authentication** if your MCP server does not require authentication, or choose a specific credential from the list
