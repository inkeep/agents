...
- **Files (`file`)**: support PDFs, Office documents (Word, Excel, PowerPoint, OpenDocument, and Apple iWork formats), plus inline UTF-8 text/code/config document formats including plain text, Markdown, HTML, CSV, logs, JSON, YAML, TOML, XML, CSS, JavaScript, TypeScript, Python, SQL, Go, Rust, Java, shell scripts, and many more programming languages, templating formats, and configuration files
