...
## File inputs (images, PDFs, text documents, and Office files)
...
- **Office document file inputs (`.docx`, `.xlsx`)**: support inline base64 `data:` payloads only. Remote URLs are not supported.

<Note>
  Office document attachments (`.docx`, `.xlsx`) are only supported when using OpenAI models. When using other model providers, office file parts are automatically removed and the model receives a note indicating the file was omitted.
</Note>
  ...
  "messages": [
    {
      ...
      "parts": [
        ...
        {
          "type": "file",
          "url": "data:application/vnd.openxmlformats-officedocument.wordprocessingml.document;base64,UEsDBBQAAAAI...",
          "mediaType": "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
          "filename": "document.docx"
        },
        {
          "type": "file",
          "url": "data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,UEsDBBQAAAAI...",
...
- **Maximum size**:
  ...
  - Office documents (`.docx`, `.xlsx`): each inline file payload is limited to **10 MB**
...
- **Content validation**:
  ...
  - Office documents (`.docx`, `.xlsx`) must contain valid ZIP magic bytes (OOXML containers are ZIP-based)
