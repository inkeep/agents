...
- **Inline data URIs** — Base64-encoded images with the format `data:image/{png|jpeg|jpg|webp};base64,{data}`
- **External URLs** — HTTP/HTTPS URLs pointing to hosted images
  ...
  "messages": [
    {
      ...
      "parts": [
        ...
        { "type": "image", "text": "data:image/png;base64,iVBORw0KGgo..." }
      ]
    }
  ]
}
