...
<Tip>
  When using the [Slack Work App](/talk-to-your-agents/slack/overview), these data events are automatically rendered as structured Slack Block Kit messages in the thread.
</Tip>
