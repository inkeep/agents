...
- **Model input replay for text documents**: persisted text attachments are injected back into prompt context as XML-tagged blocks so the model can distinguish attachment content from the user's main message
