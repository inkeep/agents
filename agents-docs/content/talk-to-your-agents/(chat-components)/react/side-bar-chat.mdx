...
<AutoTypeTable name="default" type="export { InkeepSidebarChatProps as default } from '@inkeep/agents-ui'" typeLinks={{ InkeepBaseSettings: 'inkeepbasesettings', InkeepAIChatSettings: 'inkeepaichatsettings', OpenSettingsSidebar: 'open-settings' }} />
