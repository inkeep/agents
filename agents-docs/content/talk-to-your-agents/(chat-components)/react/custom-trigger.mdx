...
<AutoTypeTable name="default" type="export { InkeepModalChatProps as default } from '@inkeep/agents-ui'" typeLinks={['InkeepBaseSettings', 'InkeepAIChatSettings', 'OpenSettingsModal']} />
