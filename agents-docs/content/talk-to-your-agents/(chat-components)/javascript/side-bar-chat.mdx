...
<AutoTypeTable name="default" type="export { InkeepEmbeddedChatProps as default } from '@inkeep/agents-ui'" typeLinks={['InkeepBaseSettings', 'InkeepAIChatSettings', 'OpenSettingsSidebar']} />
