...
<AutoTypeTable name="default" type="export { InkeepEmbeddedChatProps as default } from '@inkeep/agents-ui'" typeLinks={{ InkeepBaseSettings: 'inkeepbasesettings', InkeepAIChatSettings: 'inkeepaichatsettings', OpenSettingsSidebar: 'open-settings' }} />
...
<AutoTypeTable name="default" type="export { OpenSettingsSidebar as default } from '@inkeep/agents-ui/types'" typeLinks={['InkeepBaseSettings', 'InkeepAIChatSettings']} />
