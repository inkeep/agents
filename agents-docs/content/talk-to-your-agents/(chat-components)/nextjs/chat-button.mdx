...
<AutoTypeTable name="default" type="export { InkeepChatButtonProps as default } from '@inkeep/agents-ui'" typeLinks={['InkeepBaseSettings', 'InkeepAIChatSettings', 'OpenSettingsChatButton']} />
