...
{/* Keep the [#custom-headers] id: this anchor was shared externally before the content moved to the passing-context page. Removing it breaks existing deep links. */}
## Pass context to the widget [#custom-headers]

Send page, session, and user context to your agent so it can give personalized, situation-aware responses. See [Pass context to the widget](/talk-to-your-agents/customization/passing-context) for automatic headers, custom headers, and user properties.
