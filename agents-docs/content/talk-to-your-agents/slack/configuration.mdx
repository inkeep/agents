...
<Note>
Join from Workspace requires your organization to have a **service account user** and **preferred auth method** configured. These are set up during enterprise onboarding — contact your Inkeep solutions engineer if the toggle is unavailable.
</Note>
