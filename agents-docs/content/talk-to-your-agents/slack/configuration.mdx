...
<Note>
Only one Slack workspace can be connected per Inkeep tenant. To switch workspaces, uninstall the existing one first from the [Installation](/talk-to-your-agents/slack/installation) page.
</Note>
