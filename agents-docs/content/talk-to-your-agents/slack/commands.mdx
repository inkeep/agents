...
This opens a modal where you pick a project and agent, add any addtional instructions, then submit. The agent's response appears as a **threaded reply on the target message**, with the original message text as context.
