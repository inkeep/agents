...
### 500 error or unexpected errors

If you encounter a 500 error, re-linking your Slack account typically resolves the issue:

1. Run `/inkeep unlink` to disconnect your account
2. Run `/inkeep link` to reconnect
3. Click the link the bot sends and sign in again
