...
You can DM the Inkeep bot directly for private one-on-one conversations.

| Usage | What happens |
|-------|-------------|
| Send a message to `@Inkeep` in DMs | The workspace default agent responds in a thread |
