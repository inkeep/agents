...
The `/inkeep` slash command lets you ask questions and manage your account. Administrative commands (`link`, `unlink`, `status`, `help`) respond privately using Slack's ephemeral messages.
