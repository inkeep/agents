...
### Shared and forwarded messages

Messages that include shared or forwarded Slack content are fully supported. When you share a message and mention `@Inkeep`, the agent receives:
- Your question or prompt
- The full content of any shared or forwarded messages
- Metadata like the original author and channel

This makes it easy to ask questions about content from other conversations or channels.
...
Each follow-up appears as a new message in the channel showing your question and the agent's response.
