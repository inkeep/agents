...
| `/inkeep status` | See your linked account, active agent, and project for this channel |
...
<Tip>
Run `/inkeep status` to see exactly which agent and project are active in the current channel. Both are shown as links to the Inkeep dashboard for easy access.
</Tip>
