...
<Note>
The Slack integration is available on (Inkeep Enterprise)[https://inkeep.com/enterprise?cta_id=docs_nav]. On Enterprise, the required environment variables are already configured — no setup needed on your end beyond installing the app.
</Note>
