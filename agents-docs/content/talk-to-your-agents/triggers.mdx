...
| **Scheduled tasks** | Use [Scheduled Triggers](/typescript-sdk/scheduled-triggers) for cron-based automation |
...
For time-based automation, Inkeep also supports **Scheduled Triggers** that run agents on a cron schedule or at a specific one-time date.

<Card title="Scheduled Triggers" icon="LuClock" href="/typescript-sdk/scheduled-triggers">
  Learn how to create scheduled triggers for recurring or one-time agent tasks.
</Card>
...
<Cards>
  <Card title="Define Triggers in Code" icon="LuCode" href="/typescript-sdk/triggers">
    Learn how to create and configure triggers using the TypeScript SDK.
  </Card>
  ...
  <Card title="Scheduled Triggers" icon="LuClock" href="/typescript-sdk/scheduled-triggers">
    Create time-based triggers using cron expressions or one-time execution.
  </Card>
</Cards>
