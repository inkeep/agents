...
You can add a custom MCP server template from our [templates repository](https://github.com/inkeep/agents-cookbook) for common use cases using the [CLI](/typescript-sdk/cli-reference#inkeep-add).
```bash
