...
You can add a new MCP server from our [template library](https://github.com/inkeep/agents/tree/main/agents-cookbook/template-mcps) using the [CLI](/typescript-sdk/cli-reference#inkeep-add).
```bash
