...
<Tabs>
  ...
  <Tab title="TypeScript SDK">
    <Cards>
      ...
      <Card title="Function Tools" icon="LuCode" href="/typescript-sdk/function-tools">
...
The Inkeep Agent Platform is composed of several key components that work together.
