...
- **MCP Servers**: Connect to external services and APIs via the Model Context Protocol. You can:
  - Use **Native MCP servers** provided directly by SaaS vendors (Atlassian, Linear, Notion, etc.)
  - Access **Composio's platform** for 10,000+ pre-built integrations
  - **Build Custom servers** for your own APIs and business logic
