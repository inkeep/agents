...
<Video
  ...
  title="Visual guide to the usage of inkeep push"
/>
...
<Note>
  `inkeep add` imports a template project from our [cookbook
  library](https://github.com/inkeep/agents/tree/main/packages/agents-cookbook/template-projects)
  into your src/projects directory.
</Note>
