...
<YouTubeVideo videoId="F8n6427hjUE" title="SigNoz Cloud Setup" caption="Visual guide to the SigNoz Cloud Setup steps" />
...
<YouTubeVideo videoId="DWuL4AeRzAA" title="Local SigNoz Setup" caption="Visual guide to the Local SigNoz Setup steps" />
