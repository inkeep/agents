...
If you choose to use a different password, it must be at least 12 characters long and should contain at least one uppercase letter, one lowercase letter, one number, and one symbol.
