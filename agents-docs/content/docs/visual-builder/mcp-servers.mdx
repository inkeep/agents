...
<img
  ...
  width="60%"
  style={{ borderRadius: "10px", border: "1px solid #e1e5e9", display: "block", margin: "0 auto" }}
/>
...
1. Get familiar with [mcp-proxy](https://github.com/punkpeye/mcp-proxy) - proxy for MCP servers that use stdio transport
