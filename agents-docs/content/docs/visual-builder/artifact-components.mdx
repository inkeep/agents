...
2. Add in an id, name, and description (required fields). Optionally, enter JSON schemas for summary props and full props to define structured data extraction. If no schemas are provided, the entire response will be saved as a single piece of data.
3. Click "Submit".
