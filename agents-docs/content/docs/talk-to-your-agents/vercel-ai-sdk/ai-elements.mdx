...
The library works out of the box with Inkeep Agents via the `/api/chat` [API endpoint](/talk-to-your-agents/chat-api) since it follows the streaming protocol used by AI Elements.
