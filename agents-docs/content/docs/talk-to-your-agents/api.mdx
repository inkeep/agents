---
title: How to call your AI Agent via a Vercel AI SDK format API
sidebarTitle: Via API
description: Use a raw HTTP request to stream responses from your agent over the Vercel AI SDK data stream protocol.
icon: LuNetwork
