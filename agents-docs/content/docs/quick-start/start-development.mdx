...
```bash
cd src/projects/event-planner
inkeep push
```

### Step 5: Chat with your agent

Open the Visual Builder at http://localhost:3000, click into the weather Agent, and then click the "Try It" button to start chatting with the Agent.
