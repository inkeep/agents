...
Learn how to add Sentry monitoring to your Inkeep Agent Framework services. S
...
Ad your Sentry DSN to the .env file in the root of your workspace.
...
In `apps/run-api` and `apps/manage-api` create a new file called `instrument.ts` and add the following code:
