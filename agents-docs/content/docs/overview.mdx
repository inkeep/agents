---
title: Overview of the Inkeep Platform
sidebarTitle: Overview
icon: "LuBookOpen"
---

Inkeep is a platform to build and ship AI Agents with a **No-Code Visual Builder** and **TypeScript Agents SDK**. With **full 2-way sync**, technical and non-technical teams can create Agents in one platform.
