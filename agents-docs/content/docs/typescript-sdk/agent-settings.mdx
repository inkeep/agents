...
Agents and Sub Agents are the core building blocks of the Inkeep framework, designed to be both powerful individual workers and collaborative team members in multi-agent systems.

In Inkeep, Agent is made up of Sub Agents that can seamlessly delegate or transfer control to each other, share context, and work together to respond to a user or complete a task.
