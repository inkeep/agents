...
You can also configure MCP servers to switch based on your environment. This is useful when you want to use different MCP servers configurations for development vs production.
