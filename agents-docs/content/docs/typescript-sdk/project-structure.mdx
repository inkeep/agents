...
Inkeep Agent projects follow a standardized directory structure that enables the CLI to automatically discover and manage your Sub Agents, tools, and configurations. This convention-based approach simplifies project organization and deployment workflows.
