...
retrievalParams: {
  "connectionId": "<id-given-to-bearer-api-key>", // where <name-given-to-bearer-api-key> is the id given to the bearer api key created in through the Visual Builder
