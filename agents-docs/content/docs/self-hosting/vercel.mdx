...
If you do not have an Inkeep project already, [follow these steps](/quick-start/start-development) to create one. Then push your project to a repository on GitHub.
