...
Interested in a managed platform? Sign up for the [Inkeep Cloud waitlist](https://inkeep.com/cloud-waitlist) or learn about [Inkeep Enterprise](https://inkeep.com/enterprise). You can view a full feature comparison [here](/pricing#feature-comparison).
...
<Cards>
  <Card
    title="Follow the &lt;1min Quick Start"
    icon="LuZap"
