---
title: Build a meeting prep agent without code
sidebarTitle: Meeting Prep Agent
description: Step-by-step tutorial to build a meeting prep agent using the Visual Builder with Google Calendar and web search tools.
icon: LuCalendar
---
...
<Video
  src="https://www.youtube.com/watch?v=8DxeNhfKJco"
  title="Meeting prep agent tutorial"
/>
...
<Steps>
  ...
  <Step>
    Repeat the same process for the Exa MCP Server. The MCP Server URL is https://mcp.exa.ai/mcp.
  </Step>
</Steps>
