...
description: Step-by-step tutorial to build a fact finder agent using the TypeScript SDK with web search and citations.
icon: LuFileText
---
...
<Video
  src="youtube.com/watch?v=76HP-P269RI&feature=youtu.be"
  title="Fact finder agent tutorial"
/>
