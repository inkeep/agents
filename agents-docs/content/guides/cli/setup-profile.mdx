---
title: Set up a CLI profile
sidebarTitle: Set Up Profile
description: Create a CLI profile and authenticate with Inkeep Cloud
icon: LuUserCog
---
...
3. **Credential reference** (Cloud and Custom only): Enter a name for your credential (defaults to `inkeep-<profile-name>`)
...
<Cards>
  <Card title="Push to Cloud" icon="LuCloudUpload" href="/guides/cli/push-to-cloud">
    Push local agent configurations to Inkeep Cloud
  </Card>
