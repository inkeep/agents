...
To resolve conflicts, run `inkeep pull` first — the [interactive merge UI](/guides/cli/pull-from-remote#step-3-resolve-merge-conflicts) walks you through each conflict. Then push again.
