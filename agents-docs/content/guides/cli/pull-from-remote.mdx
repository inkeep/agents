...
This tutorial walks you through pulling agent configurations from an remote Inkeep instance to your local project. Use pull to bootstrap a local project from the [Visual Builder](/visual-builder), sync remote changes made by teammates, or set up a new development environment.
