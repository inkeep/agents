...
| **MISS** | Caching was attempted but no cache read happened — normal on the first turn, after a prefix change, or when the cache has expired. |
...
- **MISS** renders as a warning badge
