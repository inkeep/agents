...
Data backfills will not be applied when merging schema changes into project branches. You will need to run the backfill script manually after merging any schema changes.
