---
title: Working with the manage database (Doltgres)
sidebarTitle: Manage Database
description: How branch-scoped database connections work in the Inkeep Agent Framework
icon: LuDatabase
---
...
// You can directly a manage db client to resolve the ref
