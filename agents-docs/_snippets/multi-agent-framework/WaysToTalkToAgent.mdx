...
- **Via API (Vercel format)**: An API that streams responses over a server-side events (SSE) data-stream format. Use from any language/runtime, including the Vercel AI SDK. See [API (Vercel format)](/talk-to-your-agents/api).
