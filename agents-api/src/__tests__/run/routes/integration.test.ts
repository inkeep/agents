...
vi.mock('../../../env.js', async (_importOriginal) => {
  return {
    env: {
...
describe('Integration Tests', () => {
  describe('ExecutionHandler', () => {
    ...
    it('should handle basic message execution flow', async () => {
      ...
      const { A2AClient } = await import('../../../domains/run/a2a/client.js');
    ...
    it('should handle agent transfer scenarios', async () => {
      ...
      const { executeTransfer } = await import('../../../domains/run/a2a/transfer.js');
