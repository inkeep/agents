...
describe('Branch CRUD Routes - Integration Tests', () => {
  ...
  describe('GET /', () => {
    ...
    it('should not show branches from other projects', async () => {
      ...
      const res1 = await makeRequest(`/manage/tenants/${tenantId}/projects/${projectId1}/branches`);
      ...
      const res2 = await makeRequest(`/manage/tenants/${tenantId}/projects/${projectId2}/branches`);
  ...
  describe('GET /:branchName', () => {
    ...
    it('should return 404 for non-existent branch', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/branches/non-existent-branch`
      );
    ...
    it('should not return branches from other projects', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId2}/branches/${branchName}`
      );
      expect(res.status).toBe(404);
    });
  });
  ...
  describe('POST /', () => {
    ...
    it('should return 409 when creating a branch that already exists', async () => {
      ...
      // Create first branch
      const res1 = await makeRequest(`/manage/tenants/${tenantId}/projects/${projectId}/branches`, {
        method: 'POST',
        body: JSON.stringify({ name: branchName }),
      });
      ...
      const res2 = await makeRequest(`/manage/tenants/${tenantId}/projects/${projectId}/branches`, {
        method: 'POST',
        body: JSON.stringify({ name: branchName }),
      });
    ...
    it('should validate branch name format', async () => {
      ...
      const res3 = await makeRequest(`/manage/tenants/${tenantId}/projects/${projectId}/branches`, {
        method: 'POST',
    ...
    it('should accept valid branch name formats', async () => {
      ...
      // With dots
      const res4 = await makeRequest(`/manage/tenants/${tenantId}/projects/${projectId}/branches`, {
        method: 'POST',
  ...
  describe('DELETE /:branchName', () => {
    ...
    it('should not delete branches from other projects', async () => {
      ...
      const getRes = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId1}/branches/${branchName}`
      );
      expect(getRes.status).toBe(200);
    });
  });
  ...
  describe('Tenant Isolation', () => {
    it('should isolate branches across different tenants', async () => {
      ...
      const res1 = await makeRequest(
        `/manage/tenants/${tenantId1}/projects/${projectId1}/branches/${branchName}`
      );
      expect(res1.status).toBe(200);
      const body1 = await res1.json();
      ...
      const res2 = await makeRequest(
        `/manage/tenants/${tenantId2}/projects/${projectId2}/branches/${branchName}`
      );
      expect(res2.status).toBe(200);
      const body2 = await res2.json();
