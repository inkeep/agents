...
describe('Dataset Items CRUD Routes - Integration Tests', () => {
  ...
  describe('GET /{datasetId}', () => {
    it('should list dataset items (empty initially)', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/evals/dataset-items/${datasetId}`
      );
  ...
  describe('GET /{datasetId}/items/{itemId}', () => {
    it('should get a dataset item by id', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/evals/dataset-items/${datasetId}/items/${itemId}`
      );
      expect(res.status).toBe(200);
      const body = await res.json();
    ...
    it('should return 404 when item not found', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/evals/dataset-items/${datasetId}/items/non-existent-id`
      );
  ...
  describe('POST /{datasetId}/items/bulk', () => {
    it('should create multiple dataset items', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/evals/dataset-items/${datasetId}/items/bulk`,
        {
          method: 'POST',
