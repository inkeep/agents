...
describe('Evaluation Suite Configs CRUD Routes - Integration Tests', () => {
  ...
  const createTestSuiteConfig = async ({
    ...
    const createRes = await makeRequest(
      `/manage/tenants/${tenantId}/projects/${projectId}/evals/evaluation-suite-configs`,
      {
        method: 'POST',
  ...
  describe('GET /{configId}', () => {
    it('should get a suite config by id', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/evals/evaluation-suite-configs/${configId}`
      );
      expect(res.status).toBe(200);
      const body = await res.json();
    ...
    it('should return 404 when suite config not found', async () => {
      ...
      await createTestProject(manageDbClient, tenantId, projectId);
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/evals/evaluation-suite-configs/non-existent-id`
      );
  ...
  describe('POST /', () => {
    ...
    it('should create suite config with multiple evaluators', async () => {
      ...
      const relationsRes = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/evals/evaluation-suite-configs/${body.data.id}/evaluators`
      );
  ...
  describe('Evaluator Relations', () => {
    describe('GET /{configId}/evaluators', () => {
      it('should list evaluators for a suite config', async () => {
        ...
        const res = await makeRequest(
          `/manage/tenants/${tenantId}/projects/${projectId}/evals/evaluation-suite-configs/${configId}/evaluators`
        );
        expect(res.status).toBe(200);
        const body = await res.json();
    ...
    describe('POST /{configId}/evaluators/{evaluatorId}', () => {
      it('should add evaluator to suite config', async () => {
        ...
        const res = await makeRequest(
          `/manage/tenants/${tenantId}/projects/${projectId}/evals/evaluation-suite-configs/${configId}/evaluators/${evalId2}`,
          { method: 'POST' }
        );
        expect(res.status).toBe(201);
    ...
    describe('DELETE /{configId}/evaluators/{evaluatorId}', () => {
      it('should remove evaluator from suite config', async () => {
        ...
        const res = await makeRequest(
          `/manage/tenants/${tenantId}/projects/${projectId}/evals/evaluation-suite-configs/${configId}/evaluators/${evaluatorId}`,
          { method: 'DELETE' }
        );
        expect(res.status).toBe(204);
      ...
      it('should return 404 when relation not found', async () => {
        ...
        const res = await makeRequest(
          `/manage/tenants/${tenantId}/projects/${projectId}/evals/evaluation-suite-configs/${configId}/evaluators/non-existent-evaluator`,
          { method: 'DELETE' }
        );
        expect(res.status).toBe(404);
      });
  ...
  describe('End-to-End Workflow', () => {
    it('should complete full suite config lifecycle', async () => {
      ...
      const removeRes = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/evals/evaluation-suite-configs/${configId}/evaluators/${evalId1}`,
        { method: 'DELETE' }
      );
