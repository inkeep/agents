  ...
  describe('GET /', () => {
    it('should list agents with pagination (empty initially)', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agents?page=1&limit=10`
      );
    ...
    it('should handle pagination with multiple pages (small page size)', async () => {
      ...
      const page1Res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agents?page=1&limit=2`
      );
      ...
      const page2Res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agents?page=2&limit=2`
      );
      ...
      const page3Res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agents?page=3&limit=2`
      );
    ...
    it('should return empty data for page beyond available data', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agents?page=5&limit=2`
      );
      expect(res.status).toBe(200);
    ...
    it('should handle edge case with limit 1', async () => {
      ...
      const page1Res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agents?page=1&limit=1`
      );
      expect(page1Res.status).toBe(200);
      ...
      // Test middle page
      const page2Res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agents?page=2&limit=1`
      );
      expect(page2Res.status).toBe(200);
      ...
      // Test last page
      const page3Res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agents?page=3&limit=1`
      );
      expect(page3Res.status).toBe(200);
  ...
  describe('POST /', () => {
    ...
    it('should create a new agent with a provided id', async () => {
      ...
      const getRes = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agents/${providedId}`
      );
