...
describe('Agent Full CRUD Routes - Integration Tests', () => {
  ...
  describe('POST /', () => {
    it.skip('should create a full agent with all entities', async () => {
      ...
      const res = await makeRequest(`/manage/tenants/${tenantId}/projects/${projectId}/agent`, {
        method: 'POST',
  ...
  describe('GET /{agentId}', () => {
    ...
    it('should return 404 for non-existent agent', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agent/${nonExistentId}`,
        {
          method: 'GET',
        }
      );
  ...
  describe('PUT /{agentId}', () => {
    ...
    it('should delete agents that are removed from the agent definition', async () => {
      ...
      await makeRequest(`/manage/tenants/${tenantId}/projects/${projectId}/external-agents`, {
        method: 'POST',
  ...
  describe('Complex scenarios', () => {
    ...
    it('should handle concurrent agent operations on different tenants', async () => {
      ...
      await createTestProject(manageDbClient, tenant1, projectId);
      await createTestProject(manageDbClient, tenant2, projectId);
      ...
      const [res1, res2] = await Promise.all([
        makeRequest(`/manage/tenants/${tenant1}/projects/${projectId}/agent`, {
          method: 'POST',
          body: JSON.stringify(agent1Data),
        }),
        makeRequest(`/manage/tenants/${tenant2}/projects/${projectId}/agent`, {
          method: 'POST',
