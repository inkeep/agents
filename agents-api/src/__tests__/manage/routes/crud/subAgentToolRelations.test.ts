...
describe('Agent Tool Relations CRUD Routes - Integration Tests', () => {
  ...
  const createTestTool = async ({
    ...
    const createRes = await makeRequest(`/manage/tenants/${tenantId}/projects/${projectId}/tools`, {
      method: 'POST',
  ...
  describe('GET /', () => {
    ...
    it('should filter by subAgentId', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agent-tool-relations?subAgentId=${subAgentId}`
      );
      expect(res.status).toBe(200);
    ...
    it('should filter by toolId', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agent-tool-relations?toolId=${toolId}`
      );
      expect(res.status).toBe(200);
    ...
    it('should handle pagination with multiple pages', async () => {
      ...
      const page1Res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agent-tool-relations?page=1&limit=2`
      );
      ...
      const page2Res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agent-tool-relations?page=2&limit=2`
      );
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    it('should handle large page sizes gracefully', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agent-tool-relations?page=1&limit=100`
      );
      expect(res.status).toBe(200);
    ...
    it('should return empty data for page beyond available data', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agent-tool-relations?page=10&limit=10`
      );
      expect(res.status).toBe(200);
