...
describe('Agent Artifact Component CRUD Routes - Integration Tests', () => {
  ...
  const createTestAgent = async ({
    ...
    if (agentRes.status !== 201 && agentRes.status !== 409) {
      const errorText = await agentRes.clone().text();
      console.error('Failed to create agent:', agentRes.status, errorText);
  ...
  describe('GET /component/:artifactComponentId/agents', () => {
    ...
    it('should return multiple agents using artifact component', async () => {
      ...
      const { subAgentId: subAgent2Id, agentId: agent2Id } = await createTestAgent({
        tenantId,
        suffix: ' 2',
      });
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agent1Id}/sub-agent-artifact-components/component/${artifactComponentId}/agents`
      );
      expect(res.status).toBe(200);
  ...
  describe('DELETE /agent/:subAgentId/component/:artifactComponentId', () => {
    ...
    it('should return 404 for non-existent agent', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agent-artifact-components/agent/${nonExistentSubAgentId}/component/${artifactComponentId}`,
        {
          method: 'DELETE',
        }
      );
    ...
    it('should return 404 for non-existent artifact component', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agentId}/sub-agent-artifact-components/agent/${subAgentId}/component/${nonExistentArtifactComponentId}`,
        {
          method: 'DELETE',
        }
      );
  ...
  describe('End-to-End Workflow', () => {
    ...
    it('should handle multiple associations correctly', async () => {
      ...
      const agent1ArtifactComponentsRes = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agent1Id}/sub-agent-artifact-components/agent/${subAgent1Id}`
      );
      ...
      const agent2ArtifactComponentsRes = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agent2Id}/sub-agent-artifact-components/agent/${subAgent2Id}`
      );
      ...
      const ac1AgentsRes = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agent1Id}/sub-agent-artifact-components/component/${ac1Id}/agents`
      );
      ...
      const ac2AgentsRes = await makeRequest(
        `/manage/tenants/${tenantId}/projects/${projectId}/agents/${agent1Id}/sub-agent-artifact-components/component/${ac2Id}/agents`
      );
  ...
  describe('Tenant Isolation', () => {
    it('should not show associations from other tenants', async () => {
      ...
      const res = await makeRequest(
        `/manage/tenants/${tenantId2}/projects/${projectId}/agents/${agent2Id}/sub-agent-artifact-components/agent/${subAgent2Id}`
      );
      expect(res.status).toBe(200);
      const body = await res.json();
      ...
      const acRes = await makeRequest(
        `/manage/tenants/${tenantId2}/projects/${projectId}/agents/${agent2Id}/sub-agent-artifact-components/component/${ac2Id}/agents`
      );
