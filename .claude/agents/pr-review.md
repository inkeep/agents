...
| `pr-review-llm` | Problem-detection | LLM integration security: prompt injection, tool validation, data boundaries, token limits, schema validation. | Prompt injection attacks, PII leakage, RAG tenant isolation failures, and silent LLM correctness bugs. |
