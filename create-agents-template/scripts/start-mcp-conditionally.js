...
if (hasRoutes) {
  ...
  console.log(
    '\x1b[36m   Use \x1b[1m\x1b[97minkeep add --mcp <template-name>\x1b[0m\x1b[36m to add a template MCP server then restart the dev server with \x1b[1m\x1b[97mpnpm dev\x1b[0m'
  );
