 ...
 */
function compareRegistry(oldRegistry: any, newRegistry: any, diff: PlanDiff): void {
...
function comparePatterns(oldPatterns: any, newPatterns: any, diff: PlanDiff): void {
  ...
  if (oldPatterns.fileStructure.toolsLocation !== newPatterns.fileStructure.toolsLocation) {
  ...
  if (oldPatterns.namingConventions.agentSuffix !== newPatterns.namingConventions.agentSuffix) {
    diff.patternChanges.push({
  ...
  if (
    oldPatterns.namingConventions.subAgentSuffix !== newPatterns.namingConventions.subAgentSuffix
  ) {
    diff.patternChanges.push({
