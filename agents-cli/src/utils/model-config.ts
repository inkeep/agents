...
export async function promptForModelConfiguration(): Promise<ModelConfigurationResult> {
  ...
  const openaiModels = [
    ...
    { label: 'GPT-5.1 Codex Max', value: OPENAI_MODELS.GPT_5_1_CODEX_MAX },
    { label: 'GPT-5.1 Codex', value: OPENAI_MODELS.GPT_5_1_CODEX },
    { label: 'GPT-5.1 Codex Mini', value: OPENAI_MODELS.GPT_5_1_CODEX_MINI },
    { label: 'GPT-5.1 Thinking', value: OPENAI_MODELS.GPT_5_1_THINKING },
    { label: 'GPT-5.1', value: OPENAI_MODELS.GPT_5_1 },
    { label: 'GPT-5 Pro', value: OPENAI_MODELS.GPT_5_PRO },
    { label: 'GPT-5 Codex', value: OPENAI_MODELS.GPT_5_CODEX },
