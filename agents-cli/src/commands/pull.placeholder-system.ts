...
//   'http://localhost:3002',
//   '/Users/mileskaming-thanassi/agents/examples/my-weather-project/inkeep.config.ts', // Pass the config path from options
//   'default',
//   'my-weather-project'
// );

// const projectData = await apiClient.getFullProject('my-weather-project');

// console.log(createPlaceholders(projectData['graphs']['context-graph']));
