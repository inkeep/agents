...
describe('Artifact Component Generator', () => {
  ...
  describe('generateArtifactComponentDefinition', () => {
    it('should generate correct definition with all properties', () => {
      ...
      expect(definition).toContain("description: 'Structured factual information extracted from search results',");
    ...
    it('should wrap preview fields with preview() function', () => {
      ...
      expect(definition).toContain('title: preview(z.string().describe("Title of the source document")),');
      expect(definition).toContain('url: preview(z.string().describe("URL of the source document")),');
      expect(definition).toContain('record_type: preview(z.string().describe("Type of record (documentation, blog, guide, etc.)")),');
    });
  ...
  <div>{{content}}</div>
    ...
    it('should handle mixed preview and non-preview fields', () => {
      ...
      expect(definition).toContain('previewField: preview(z.string().describe("This is shown in preview")),');
      expect(definition).toContain('regularField: z.string().describe("This is not shown in preview"),');
    });
  });
  ...
  describe('compilation tests', () => {
    it('should generate code that compiles and creates a working artifact component', async () => {
      ...
      expect(result.description).toBe('Structured factual information extracted from search results');
