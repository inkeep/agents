...
describe('Context Config CRUD Routes - Integration Tests', () => {
  ...
  const createTestContextConfig = async ({
    ...
    const createRes = await makeRequest(
      `/tenants/${tenantId}/projects/${projectId}/agents/${testGraphId}/context-configs`,
      {
        method: 'POST',
  ...
  describe('GET /', () => {
    it('should list context configs with pagination (empty initially)', async () => {
      ...
      const res = await makeRequest(
        `/tenants/${tenantId}/projects/${projectId}/agents/${testGraphId}/context-configs?page=1&limit=10`
      );
    ...
    it('should handle pagination with multiple pages', async () => {
      ...
      const page1Res = await makeRequest(
        `/tenants/${tenantId}/projects/${projectId}/agents/${testGraphId}/context-configs?page=1&limit=2`
      );
      ...
      const page2Res = await makeRequest(
        `/tenants/${tenantId}/projects/${projectId}/agents/${testGraphId}/context-configs?page=2&limit=2`
      );
      ...
      const page3Res = await makeRequest(
        `/tenants/${tenantId}/projects/${projectId}/agents/${testGraphId}/context-configs?page=3&limit=2`
      );
    ...
    it('should return empty data for page beyond available data', async () => {
      ...
      const res = await makeRequest(
        `/tenants/${tenantId}/projects/${projectId}/agents/${testGraphId}/context-configs?page=5&limit=2`
      );
      expect(res.status).toBe(200);
  ...
  describe('GET /{id}', () => {
    it('should get a context config by id', async () => {
      ...
      const res = await makeRequest(
        `/tenants/${tenantId}/projects/${projectId}/agents/${testGraphId}/context-configs/${contextConfigId}`
      );
      expect(res.status).toBe(200);
    ...
    it('should return 404 when context config not found', async () => {
      ...
      await ensureTestProject(tenantId, projectId);
      const res = await makeRequest(
        `/tenants/${tenantId}/projects/${projectId}/agents/${testGraphId}/context-configs/non-existent-id`
      );
