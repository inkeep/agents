...
import { runConversationEvaluation } from '../services/EvaluationService';
...
app.openapi(
  ...
  async (c) => {
    ...
    try {
      const row = await getConversationEvaluationConfig(dbClient)({ tenantId, conversationEvaluationConfigId: id });
      if (!row) {
        return c.json(
...
app.openapi(
  createRoute({
    ...
    request: {
      ...
      body: { content: { 'application/json': { schema: UpdateConversationEvaluationConfigRequestSchema } } },
    },
    responses: {
      200: {
...
app.openapi(
  createRoute({
    method: 'post',
    path: '/evaluations/configs/{id}/start',
    summary: 'Start Conversation Evaluation Config',
    operationId: 'start-conversation-evaluation-config',
    tags: ['Evaluations'],
    request: { params: ConversationEvaluationConfigIdParamsSchema },
    responses: {
      200: { description: 'Started', content: { 'application/json': { schema: ConversationEvaluationConfigResponseSchema } } },
      ...commonGetErrorResponses,
    },
  }),
  async (c) => {
...
app.openapi(
  createRoute({
    method: 'post',
    path: '/evaluations/configs/{id}/stop',
    summary: 'Stop Conversation Evaluation Config',
    operationId: 'stop-conversation-evaluation-config',
    tags: ['Evaluations'],
    request: { params: ConversationEvaluationConfigIdParamsSchema },
    responses: {
      200: { description: 'Stopped', content: { 'application/json': { schema: ConversationEvaluationConfigResponseSchema } } },
      ...commonGetErrorResponses,
    },
  }),
  async (c) => {
...
// GET /evaluations/conversations/run
app.openapi(
  createRoute({
    method: 'post',
    path: '/evaluations/conversations/run',
...
app.openapi(
  createRoute({
    method: 'get',
    path: '/evaluations/conversations/{conversationId}',
...
app.openapi(
  createRoute({
    method: 'get',
    path: '/evaluations/results/conversation/{conversationId}',
...
app.openapi(
  createRoute({
    method: 'get',
    path: '/evaluations/results/evaluator/{evaluatorId}',
...
app.openapi(
  createRoute({
    method: 'get',
    path: '/evaluations/evaluators/{evaluatorId}',
...
app.openapi(
  ...
  async (c) => {
    ...
    try {
      ...
      return c.json(
        createApiError({ code: 'internal_server_error', message: 'Failed to get evaluation result' }),
        500
      ) as any;
    }
  }
...
app.openapi(
  createRoute({
    method: 'post',
    path: '/evaluations/datasets/{datasetId}/items',
...
app.openapi(
  createRoute({
    method: 'get',
    path: '/evaluations/dataset-items/{id}',
...
app.openapi(
  createRoute({
    method: 'post',
    path: '/evaluations/test-suite-configs',
  ...
  async (c) => {
    ...
    try {
      ...
      return c.json(
        createApiError({ code: 'internal_server_error', message: 'Failed to create test suite config' }),
        500
      ) as any;
    }
  }
...
app.openapi(
  createRoute({
    method: 'get',
    path: '/evaluations/test-suite-configs/{id}',
  ...
  async (c) => {
    ...
    try {
      ...
      return c.json(
        createApiError({ code: 'internal_server_error', message: 'Failed to get test suite config' }),
        500
      ) as any;
    }
  }
...
app.openapi(
  ...
  async (c) => {
    ...
    try {
      ...
      return c.json(
        createApiError({ code: 'internal_server_error', message: 'Failed to list test suite configs' }),
        500
      ) as any;
    }
  }
...
app.openapi(
  ...
  async (c) => {
    ...
    try {
      ...
      return c.json(
        createApiError({ code: 'internal_server_error', message: 'Failed to update test suite config' }),
        500
      ) as any;
    }
  }
...
app.openapi(
  ...
  async (c) => {
    ...
    try {
      ...
      return c.json(
        createApiError({ code: 'internal_server_error', message: 'Failed to delete test suite config' }),
        500
      ) as any;
    }
  }
