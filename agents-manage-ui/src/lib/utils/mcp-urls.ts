...
export function getOAuthLoginUrl({
  ...
  const url = `${PUBLIC_INKEEP_AGENTS_API_URL}/manage/tenants/${encodeURIComponent(tenantId)}/projects/${encodeURIComponent(projectId)}/tools/${encodeURIComponent(id)}/oauth/login`;
