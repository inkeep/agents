  ...
  function getInheritance(key: 'structuredOutput' | 'summarizer') {
    ...
    if (projectModel?.model) {
      return {
        ...
        providerOptions: projectModel.providerOptions,
    ...
    if (agentModels?.base?.model) {
      return {
        ...
        providerOptions: agentModels.base.providerOptions,
    ...
    if (projectModels?.base?.model) {
      return {
        ...
        providerOptions: projectModels.base.providerOptions,
  ...
  return (
    <div className="space-y-8">
      ...
      <ModelConfiguration
        ...
        name={`${basePath}.base`}
        inherited={{
          model: agentModels?.base?.model || projectModels?.base?.model,
          providerOptions: agentModels?.base?.model
            ? agentModels?.base?.providerOptions
            : projectModels?.base?.providerOptions,
          fallbackModels: agentModels?.base?.fallbackModels || projectModels?.base?.fallbackModels,
          allowedProviders:
      ...
      <CollapsibleSettings defaultOpen={!!hasAdvancedOptions} title="Advanced Model Options">
        <ModelConfiguration
          ...
          inherited={structuredOutputInheritance}
          label={
            <div className="flex items-center gap-2">
        ...
        <ModelConfiguration
          ...
          inherited={summarizerInheritance}
          label={
            <div className="flex items-center gap-2">
              Summarizer model
              <InheritanceIndicator
