  ...
  return (
    <div className="flex flex-col gap-2 max-w-72 w-40 min-w-0">
      <div className="group/node-stack flex flex-col gap-0 group-hover/node-stack:gap-2 group-focus-within/node-stack:gap-2">
        ...
        <div className="flex flex-col gap-2 overflow-hidden max-h-0 opacity-0 -translate-y-1 pointer-events-none transition-[max-height,opacity,transform] duration-300 ease-out group-hover/node-stack:max-h-[400px] group-hover/node-stack:opacity-100 group-hover/node-stack:translate-y-0 group-hover/node-stack:pointer-events-auto group-focus-within/node-stack:max-h-[400px] group-focus-within/node-stack:opacity-100 group-focus-within/node-stack:translate-y-0 group-focus-within/node-stack:pointer-events-auto">
