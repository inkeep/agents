...
interface NewEvaluatorItemProps {
  tenantId: string;
}

export function NewEvaluatorItem({ tenantId }: NewEvaluatorItemProps) {
  const href = `/${tenantId}/evaluations/evaluators/new`;
      ...
      <ItemCardLink href={href}>
        <ItemCardHeader>
          <div className="flex items-center gap-2">
            ...
            <ItemCardTitle className="text-md">New Evaluator</ItemCardTitle>
          </div>
        </ItemCardHeader>
      </ItemCardLink>
