		...
		<div className="space-y-4">
			<div>
				...
				<p className="text-sm text-muted-foreground mt-1">
					Set default execution limits that will be inherited by graphs and
				...
				<CollapsibleContent className="space-y-6 mt-4 border rounded-md p-4 bg-muted/30">
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						...
						<div className="space-y-2">
							...
							<p className="text-xs text-muted-foreground">
								Maximum number of agent transfers per conversation (graph-level,
								default: 10)
							</p>
					...
					<div className="text-xs text-muted-foreground p-3 bg-blue-50 dark:bg-blue-950/20 rounded-md border border-blue-200 dark:border-blue-800">
						...
						<ul className="space-y-1 text-blue-800 dark:text-blue-200">
							<li>
								• <strong>transferCountIs</strong>: Project → Graph only
								(graph-level limit)
							</li>
							<li>
								• <strong>stepCountIs</strong>: Project → Agent only
								(agent-level limit)
							</li>
							<li>
							...
							<li>
								• <strong>Error limit</strong> is hardcoded to 3 errors across
								all levels
							</li>
						</ul>
					</div>
