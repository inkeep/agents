...
export function SimulationAgentForm({ control }: SimulationAgentFormProps) {
  ...
  const modelError = 
    errors.simulationAgent &&
    typeof errors.simulationAgent === 'object' &&
    errors.simulationAgent.model &&
    typeof errors.simulationAgent.model === 'object' &&
    errors.simulationAgent.model.model;
  
  const promptError = 
    errors.simulationAgent &&
    typeof errors.simulationAgent === 'object' &&
    errors.simulationAgent.prompt;
