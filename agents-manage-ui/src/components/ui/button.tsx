...
const buttonVariants = cva(
  "inkeep-aria-invalid inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]",
  {
    variants: {
      variant: {
        default:
        ...
        'gray-outline':
          'text-gray-600 border border-border bg-background hover:bg-accent dark:text-muted-foreground',
        secondary:
