        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              ...
              className="hover:transparent text-gray-500 hover:text-gray-700 dark:text-whiteAlpha-500 dark:hover:text-whiteAlpha-600 flex flex-row gap-2 rounded w-6 h-6"
              size="sm"
              variant="ghost"
