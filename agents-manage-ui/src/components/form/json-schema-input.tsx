...
interface JsonSchemaInputProps<FV extends FieldValues, TV = FieldValues> {
...
export function JsonSchemaInput<FV extends FieldValues, TV extends FieldValues>({
  control,
  name,
  label = 'JSON Schema',
  placeholder,
