...
| **Internal spec & AI-dev scaffolding** | Maintainer-only automation scaffolding for PRDs and autonomous flows (Ralph, proxies, templates). | — | `.ai-dev/`, `.ai-dev/ralph.sh`, `.ai-dev/prd-template.json`, `.ai-dev/ralph-prompt.md` |
