...
export const ListDatasetsRequest$zodSchema: z.ZodType<ListDatasetsRequest> = z
  .object({
...
> = z.object({
  data: z.array(Dataset$zodSchema),
...
export const ListDatasetsResponse$zodSchema: z.ZodType<ListDatasetsResponse> = z
  .object({
