...
export const DeleteDatasetRequest$zodSchema: z.ZodType<DeleteDatasetRequest> = z
  .object({
    datasetId: z.string(),
...
export const DeleteDatasetResponse$zodSchema: z.ZodType<DeleteDatasetResponse> =
  z.object({
