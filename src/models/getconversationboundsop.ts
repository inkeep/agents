...
import {
  ...
  ConversationBoundsResponse$zodSchema,
} from "./conversationboundsresponse.js";
...
export type GetConversationBoundsRequest = {
  tenantId: string;
  projectId: string;
  id: string;
};

export const GetConversationBoundsRequest$zodSchema: z.ZodType<
...
export type GetConversationBoundsResponse = {
  ContentType: string;
  StatusCode: number;
  RawResponse: Response;
  ConversationBoundsResponse?: ConversationBoundsResponse | undefined;
...
export const GetConversationBoundsResponse$zodSchema: z.ZodType<
...
> = z.object({
  ...
  ConversationBoundsResponse: ConversationBoundsResponse$zodSchema.optional()
    .describe("Conversation time bounds for trace queries"),
