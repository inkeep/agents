...
export enum CreateAppAcceptEnum {
...
async function $do(
  client$: InkeepAgentsCore,
  request: CreateAppRequest,
  options?: RequestOptions & { acceptHeaderOverride?: CreateAppAcceptEnum },
): Promise<
  [
    Result<
      Response,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateAppRequest$zodSchema.parse(value$),
