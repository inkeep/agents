 ...
 */
export function externalAgentsCreateSubAgentExternalAgentRelation(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      CreateSubAgentExternalAgentRelationRequest$zodSchema.parse(value$),
