 ...
 */
export function externalAgentsGetSubAgentExternalAgentRelationById(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      GetSubAgentExternalAgentRelationByIdRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc(
    "/manage/tenants/{tenantId}/projects/{projectId}/agents/{agentId}/sub-agents/{subAgentId}/external-agent-relations/{id}",
  )(
    pathParams$,
  );
