...
> {
  ...
  >(
    ...
    M.json(400, DeleteToolResponse$zodSchema, {
      ctype: "application/problem+json",
      key: "BadRequest",
    }),
    M.json(401, DeleteToolResponse$zodSchema, {
      ctype: "application/problem+json",
      key: "Unauthorized",
    }),
    M.json(403, DeleteToolResponse$zodSchema, {
      ctype: "application/problem+json",
      key: "Forbidden",
    }),
    M.json(404, DeleteToolResponse$zodSchema, {
      ctype: "application/problem+json",
      key: "NotFound",
    }),
    M.json(422, DeleteToolResponse$zodSchema, {
      ctype: "application/problem+json",
      key: "UnprocessableEntity",
    }),
    M.json(500, DeleteToolResponse$zodSchema, {
      ctype: "application/problem+json",
