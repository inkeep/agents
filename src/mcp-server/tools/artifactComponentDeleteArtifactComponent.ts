...
export const tool$artifactComponentDeleteArtifactComponent: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await artifactComponentDeleteArtifactComponent(
      client,
      args.request,
