...
export const tool$subAgentRelationsGetSubAgentRelationById: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await subAgentRelationsGetSubAgentRelationById(
      client,
      args.request,
