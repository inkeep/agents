...
export const tool$contextConfigGetContextConfigById: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await contextConfigGetContextConfigById(
      client,
      args.request,
