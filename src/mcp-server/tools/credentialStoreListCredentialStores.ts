...
export const tool$credentialStoreListCredentialStores: ToolDefinition<
  typeof args
> = {
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await credentialStoreListCredentialStores(
      client,
      args.request,
