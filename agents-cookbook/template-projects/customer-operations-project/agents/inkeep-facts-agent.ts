...
const factsAgent = subAgent({
  id: `facts-agent`,
  name: `Facts Agent`,
  description: `Customer support agent specialized in documentation, API usage, and technical support, strictly grounded in official project documentation.`,
...
export const inkeepFactsAgent = agent({
  id: `inkeep-facts-agent`,
  name: `Inkeep Facts Agent`,
  description: `Top-level reusable documentation and facts agent for Customer Operations, used as a Team Agent by other workflows.`,
  defaultSubAgent: factsAgent,
  subAgents: () => [factsAgent]
});