...
const parseRuntimeConfig = () => {
  ...
  return {
    ...
    AGENT_EXECUTION_TRANSFER_COUNT_DEFAULT:
      envOverrides.AGENTS_EXECUTION_TRANSFER_COUNT_DEFAULT ??
      runtimeConsts.AGENT_EXECUTION_TRANSFER_COUNT_DEFAULT,
    AGENT_EXECUTION_MAX_CONSECUTIVE_ERRORS:
      envOverrides.AGENTS_EXECUTION_MAX_CONSECUTIVE_ERRORS ??
      runtimeConsts.AGENT_EXECUTION_MAX_CONSECUTIVE_ERRORS,

    // Sub-Agent Turn Execution
    SUB_AGENT_TURN_GENERATION_STEPS_DEFAULT:
      envOverrides.AGENTS_SUB_AGENT_TURN_GENERATION_STEPS_DEFAULT ??
      runtimeConsts.SUB_AGENT_TURN_GENERATION_STEPS_DEFAULT,

    // LLM Generation Timeouts
    LLM_GENERATION_FIRST_CALL_TIMEOUT_MS_STREAMING:
      envOverrides.AGENTS_LLM_GENERATION_FIRST_CALL_TIMEOUT_MS_STREAMING ??
      runtimeConsts.LLM_GENERATION_FIRST_CALL_TIMEOUT_MS_STREAMING,
    LLM_GENERATION_FIRST_CALL_TIMEOUT_MS_NON_STREAMING:
      envOverrides.AGENTS_LLM_GENERATION_FIRST_CALL_TIMEOUT_MS_NON_STREAMING ??
      runtimeConsts.LLM_GENERATION_FIRST_CALL_TIMEOUT_MS_NON_STREAMING,
    LLM_GENERATION_SUBSEQUENT_CALL_TIMEOUT_MS:
      envOverrides.AGENTS_LLM_GENERATION_SUBSEQUENT_CALL_TIMEOUT_MS ??
      runtimeConsts.LLM_GENERATION_SUBSEQUENT_CALL_TIMEOUT_MS,
    LLM_GENERATION_MAX_ALLOWED_TIMEOUT_MS:
      envOverrides.AGENTS_LLM_GENERATION_MAX_ALLOWED_TIMEOUT_MS ??
      runtimeConsts.LLM_GENERATION_MAX_ALLOWED_TIMEOUT_MS,

    // Function Tool Execution (Sandbox)
    FUNCTION_TOOL_EXECUTION_TIMEOUT_MS_DEFAULT:
      envOverrides.AGENTS_FUNCTION_TOOL_EXECUTION_TIMEOUT_MS_DEFAULT ??
      runtimeConsts.FUNCTION_TOOL_EXECUTION_TIMEOUT_MS_DEFAULT,
    FUNCTION_TOOL_SANDBOX_VCPUS_DEFAULT:
      envOverrides.AGENTS_FUNCTION_TOOL_SANDBOX_VCPUS_DEFAULT ??
      runtimeConsts.FUNCTION_TOOL_SANDBOX_VCPUS_DEFAULT,
    FUNCTION_TOOL_SANDBOX_POOL_TTL_MS:
      envOverrides.AGENTS_FUNCTION_TOOL_SANDBOX_POOL_TTL_MS ??
      runtimeConsts.FUNCTION_TOOL_SANDBOX_POOL_TTL_MS,
    FUNCTION_TOOL_SANDBOX_MAX_USE_COUNT:
      envOverrides.AGENTS_FUNCTION_TOOL_SANDBOX_MAX_USE_COUNT ??
      runtimeConsts.FUNCTION_TOOL_SANDBOX_MAX_USE_COUNT,
    FUNCTION_TOOL_SANDBOX_MAX_OUTPUT_SIZE_BYTES:
      envOverrides.AGENTS_FUNCTION_TOOL_SANDBOX_MAX_OUTPUT_SIZE_BYTES ??
      runtimeConsts.FUNCTION_TOOL_SANDBOX_MAX_OUTPUT_SIZE_BYTES,
    FUNCTION_TOOL_SANDBOX_QUEUE_WAIT_TIMEOUT_MS:
      envOverrides.AGENTS_FUNCTION_TOOL_SANDBOX_QUEUE_WAIT_TIMEOUT_MS ??
      runtimeConsts.FUNCTION_TOOL_SANDBOX_QUEUE_WAIT_TIMEOUT_MS,
    FUNCTION_TOOL_SANDBOX_CLEANUP_INTERVAL_MS:
      envOverrides.AGENTS_FUNCTION_TOOL_SANDBOX_CLEANUP_INTERVAL_MS ??
      runtimeConsts.FUNCTION_TOOL_SANDBOX_CLEANUP_INTERVAL_MS,

    // MCP Tool Execution
    MCP_TOOL_REQUEST_TIMEOUT_MS_DEFAULT:
      envOverrides.AGENTS_MCP_TOOL_REQUEST_TIMEOUT_MS_DEFAULT ??
      runtimeConsts.MCP_TOOL_REQUEST_TIMEOUT_MS_DEFAULT,
    MCP_TOOL_CONNECTION_TIMEOUT_MS:
      envOverrides.AGENTS_MCP_TOOL_CONNECTION_TIMEOUT_MS ?? runtimeConsts.MCP_TOOL_CONNECTION_TIMEOUT_MS,
    MCP_TOOL_MAX_RETRIES:
      envOverrides.AGENTS_MCP_TOOL_MAX_RETRIES ?? runtimeConsts.MCP_TOOL_MAX_RETRIES,
    MCP_TOOL_MAX_RECONNECTION_DELAY_MS:
      envOverrides.AGENTS_MCP_TOOL_MAX_RECONNECTION_DELAY_MS ??
      runtimeConsts.MCP_TOOL_MAX_RECONNECTION_DELAY_MS,
    MCP_TOOL_INITIAL_RECONNECTION_DELAY_MS:
      envOverrides.AGENTS_MCP_TOOL_INITIAL_RECONNECTION_DELAY_MS ??
      runtimeConsts.MCP_TOOL_INITIAL_RECONNECTION_DELAY_MS,
    MCP_TOOL_RECONNECTION_DELAY_GROWTH_FACTOR:
      envOverrides.AGENTS_MCP_TOOL_RECONNECTION_DELAY_GROWTH_FACTOR ??
      runtimeConsts.MCP_TOOL_RECONNECTION_DELAY_GROWTH_FACTOR,

    // Delegation Tool Execution
    DELEGATION_TOOL_BACKOFF_INITIAL_INTERVAL_MS:
      envOverrides.AGENTS_DELEGATION_TOOL_BACKOFF_INITIAL_INTERVAL_MS ??
      runtimeConsts.DELEGATION_TOOL_BACKOFF_INITIAL_INTERVAL_MS,
    DELEGATION_TOOL_BACKOFF_MAX_INTERVAL_MS:
      envOverrides.AGENTS_DELEGATION_TOOL_BACKOFF_MAX_INTERVAL_MS ??
      runtimeConsts.DELEGATION_TOOL_BACKOFF_MAX_INTERVAL_MS,
    DELEGATION_TOOL_BACKOFF_EXPONENT:
      envOverrides.AGENTS_DELEGATION_TOOL_BACKOFF_EXPONENT ??
      runtimeConsts.DELEGATION_TOOL_BACKOFF_EXPONENT,
    DELEGATION_TOOL_BACKOFF_MAX_ELAPSED_TIME_MS:
      envOverrides.AGENTS_DELEGATION_TOOL_BACKOFF_MAX_ELAPSED_TIME_MS ??
      runtimeConsts.DELEGATION_TOOL_BACKOFF_MAX_ELAPSED_TIME_MS,

    // General A2A Communication
    A2A_BACKOFF_INITIAL_INTERVAL_MS:
      envOverrides.AGENTS_A2A_BACKOFF_INITIAL_INTERVAL_MS ??
      runtimeConsts.A2A_BACKOFF_INITIAL_INTERVAL_MS,
    A2A_BACKOFF_MAX_INTERVAL_MS:
      envOverrides.AGENTS_A2A_BACKOFF_MAX_INTERVAL_MS ?? runtimeConsts.A2A_BACKOFF_MAX_INTERVAL_MS,
    A2A_BACKOFF_EXPONENT: envOverrides.AGENTS_A2A_BACKOFF_EXPONENT ?? runtimeConsts.A2A_BACKOFF_EXPONENT,
    A2A_BACKOFF_MAX_ELAPSED_TIME_MS:
      envOverrides.AGENTS_A2A_BACKOFF_MAX_ELAPSED_TIME_MS ??
      runtimeConsts.A2A_BACKOFF_MAX_ELAPSED_TIME_MS,

    // Artifact Processing
    ARTIFACT_GENERATION_MAX_RETRIES:
      envOverrides.AGENTS_ARTIFACT_GENERATION_MAX_RETRIES ??
      runtimeConsts.ARTIFACT_GENERATION_MAX_RETRIES,
    ARTIFACT_SESSION_MAX_PENDING:
      envOverrides.AGENTS_ARTIFACT_SESSION_MAX_PENDING ?? runtimeConsts.ARTIFACT_SESSION_MAX_PENDING,
    ARTIFACT_SESSION_MAX_PREVIOUS_SUMMARIES:
      envOverrides.AGENTS_ARTIFACT_SESSION_MAX_PREVIOUS_SUMMARIES ??
      runtimeConsts.ARTIFACT_SESSION_MAX_PREVIOUS_SUMMARIES,
    ARTIFACT_GENERATION_BACKOFF_INITIAL_MS:
      envOverrides.AGENTS_ARTIFACT_GENERATION_BACKOFF_INITIAL_MS ??
      runtimeConsts.ARTIFACT_GENERATION_BACKOFF_INITIAL_MS,
    ARTIFACT_GENERATION_BACKOFF_MAX_MS:
      envOverrides.AGENTS_ARTIFACT_GENERATION_BACKOFF_MAX_MS ??
      runtimeConsts.ARTIFACT_GENERATION_BACKOFF_MAX_MS,

    // Session & Cache Management
    SESSION_TOOL_RESULT_CACHE_TIMEOUT_MS:
      envOverrides.AGENTS_SESSION_TOOL_RESULT_CACHE_TIMEOUT_MS ??
      runtimeConsts.SESSION_TOOL_RESULT_CACHE_TIMEOUT_MS,
    SESSION_CLEANUP_INTERVAL_MS:
      envOverrides.AGENTS_SESSION_CLEANUP_INTERVAL_MS ?? runtimeConsts.SESSION_CLEANUP_INTERVAL_MS,

    // Status Updates & Streaming
    STATUS_UPDATE_DEFAULT_NUM_EVENTS:
      envOverrides.AGENTS_STATUS_UPDATE_DEFAULT_NUM_EVENTS ??
      runtimeConsts.STATUS_UPDATE_DEFAULT_NUM_EVENTS,
    STATUS_UPDATE_DEFAULT_INTERVAL_SECONDS:
      envOverrides.AGENTS_STATUS_UPDATE_DEFAULT_INTERVAL_SECONDS ??
      runtimeConsts.STATUS_UPDATE_DEFAULT_INTERVAL_SECONDS,

    // Stream Buffer Limits
    STREAM_PARSER_MAX_SNAPSHOT_SIZE:
      envOverrides.AGENTS_STREAM_PARSER_MAX_SNAPSHOT_SIZE ??
      runtimeConsts.STREAM_PARSER_MAX_SNAPSHOT_SIZE,
    STREAM_PARSER_MAX_STREAMED_SIZE:
      envOverrides.AGENTS_STREAM_PARSER_MAX_STREAMED_SIZE ??
      runtimeConsts.STREAM_PARSER_MAX_STREAMED_SIZE,
    STREAM_PARSER_MAX_COLLECTED_PARTS:
      envOverrides.AGENTS_STREAM_PARSER_MAX_COLLECTED_PARTS ??
      runtimeConsts.STREAM_PARSER_MAX_COLLECTED_PARTS,
    STREAM_BUFFER_MAX_SIZE_BYTES:
      envOverrides.AGENTS_STREAM_BUFFER_MAX_SIZE_BYTES ?? runtimeConsts.STREAM_BUFFER_MAX_SIZE_BYTES,
    STREAM_TEXT_GAP_THRESHOLD_MS:
      envOverrides.AGENTS_STREAM_TEXT_GAP_THRESHOLD_MS ?? runtimeConsts.STREAM_TEXT_GAP_THRESHOLD_MS,
    STREAM_MAX_LIFETIME_MS:
      envOverrides.AGENTS_STREAM_MAX_LIFETIME_MS ?? runtimeConsts.STREAM_MAX_LIFETIME_MS,

    // Conversation History
    CONVERSATION_HISTORY_DEFAULT_LIMIT:
      envOverrides.AGENTS_CONVERSATION_HISTORY_DEFAULT_LIMIT ??
      runtimeConsts.CONVERSATION_HISTORY_DEFAULT_LIMIT,
  };
};
